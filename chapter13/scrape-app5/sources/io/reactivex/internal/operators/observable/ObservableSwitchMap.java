...
public final class ObservableSwitchMap<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    static final class SwitchMapObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        void disposeInner() {
            ...
            if (a2 != switchMapInnerObserver && (a = this.active.getAndSet(switchMapInnerObserver)) != CANCELLED && a != null) {
                a.cancel();
            }
        }

        /* JADX INFO: Multiple debug info for r10v2 boolean: [D('ex' java.lang.Throwable), D('d' boolean)] */
        void drain() {
            SimpleQueue<R> q;
            boolean retry;
            R r;
