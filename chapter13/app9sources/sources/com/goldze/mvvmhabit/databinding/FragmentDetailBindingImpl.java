...
public class FragmentDetailBindingImpl extends FragmentDetailBinding {
    ...
    private FragmentDetailBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (TextView) objArr[8], (TextView) objArr[3], (ImageView) objArr[1], (TextView) objArr[12], (TextView) objArr[7], (TextView) objArr[10], (TextView) objArr[5], (TextView) objArr[11], (TextView) objArr[6], (TextView) objArr[9], (TextView) objArr[4], (TextView) objArr[2]);
        this.mDirtyFlags = -1;
    ...
    protected void executeBindings() {
        ...
        if (j2 != 0) {
            ...
            ViewAdapter.setImageUri(this.cover, str5, C0690R.mipmap.ic_launcher_round);
