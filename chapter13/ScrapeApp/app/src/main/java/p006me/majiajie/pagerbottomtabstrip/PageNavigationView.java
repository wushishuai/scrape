...
public class PageNavigationView extends ViewGroup {
    ...
    public PageNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setPadding(0, 0, 0, 0);
        TypedArray a = context.obtainStyledAttributes(attrs, C1029R.styleable.PageNavigationView);
        if (a.hasValue(C1029R.styleable.PageNavigationView_NavigationPaddingTop)) {
            this.mTabPaddingTop = a.getDimensionPixelSize(C1029R.styleable.PageNavigationView_NavigationPaddingTop, 0);
        }
        if (a.hasValue(C1029R.styleable.PageNavigationView_NavigationPaddingBottom)) {
            this.mTabPaddingBottom = a.getDimensionPixelSize(C1029R.styleable.PageNavigationView_NavigationPaddingBottom, 0);
        }
        a.recycle();
    }
