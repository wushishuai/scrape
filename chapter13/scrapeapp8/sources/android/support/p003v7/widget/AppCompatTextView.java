...
public class AppCompatTextView extends TextView implements TintableBackgroundView, AutoSizeableTextView {
    ...
    @Override // android.widget.TextView
    public void setFirstBaselineToTopHeight(@IntRange(from = 0) @AbstractC0065Px int firstBaselineToTopHeight) {
    ...
    @Override // android.widget.TextView
    public void setLastBaselineToBottomHeight(@IntRange(from = 0) @AbstractC0065Px int lastBaselineToBottomHeight) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    @Override // android.widget.TextView
    public void setLineHeight(@IntRange(from = 0) @AbstractC0065Px int lineHeight) {
