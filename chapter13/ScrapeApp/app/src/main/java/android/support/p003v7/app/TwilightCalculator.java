...
class TwilightCalculator {
    ...
    /* renamed from: C1 */
    private static final float f24C1 = 0.0334196f;

    /* renamed from: C2 */
    private static final float f25C2 = 3.49066E-4f;

    /* renamed from: C3 */
    private static final float f26C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0 */
    private static final float f27J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        double d2 = (double) (daysSince2000 - f27J0);
        Double.isNaN(d2);
        double round = (double) (f27J0 + ((float) Math.round(d2 - arcLongitude)));
        Double.isNaN(round);
        ...
        if (cosHourAngle >= 1.0d) {
            ...
            Double.isNaN(d4);
            this.sunrise = Math.round((solarTransitJ2000 - d4) * 8.64E7d) + UTC_2000;
