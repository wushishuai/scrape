...
public class MaterialCardView extends CardView {
    ...
    public MaterialCardView(Context context, AttributeSet attrs) {
        this(context, attrs, C0097R.attr.materialCardViewStyle);
    }

    public MaterialCardView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0097R.styleable.MaterialCardView, defStyleAttr, C0097R.style.Widget_MaterialComponents_CardView, new int[0]);
