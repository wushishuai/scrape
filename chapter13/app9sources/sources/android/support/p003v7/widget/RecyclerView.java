...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public void onScrolled(@AbstractC0065Px int i, @AbstractC0065Px int i2) {
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0460R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0460R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0460R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes2.getBoolean(C0460R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0460R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0460R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0460R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0460R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    */
    ...
    public void smoothScrollBy(@AbstractC0065Px int i, @AbstractC0065Px int i2) {
        smoothScrollBy(i, i2, null);
    }

    public void smoothScrollBy(@AbstractC0065Px int i, @AbstractC0065Px int i2, @Nullable Interpolator interpolator) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutFrozen) {
    ...
    */
    protected void onAttachedToWindow() {
        ...
        L_0x001e:
            ...
            boolean r0 = android.support.p003v7.widget.RecyclerView.ALLOW_THREAD_GAP_WORK
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    android.support.p003v7.widget.RecyclerView.ViewHolder findViewHolderForPosition(int r6, boolean r7) {
        /*
            r5 = this;
    ...
    public void offsetChildrenVertical(@AbstractC0065Px int i) {
        int childCount = this.mChildHelper.getChildCount();
    ...
    public void offsetChildrenHorizontal(@AbstractC0065Px int i) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
    ...
    public class ViewFlinger implements Runnable {
        ...
        ViewFlinger() {
            ...
            this.mScroller = new OverScroller(r3.getContext(), RecyclerView.sQuinticInterpolator);
        }
    ...
    public final class Recycler {
        ...
        /*
            ...
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public android.support.p003v7.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            /*
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0460R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0460R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0460R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0460R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0460R.styleable.RecyclerView_stackFromEnd, false);
            obtainStyledAttributes.recycle();
            return properties;
        }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0460R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0460R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0460R.dimen.fastscroll_margin));
    }
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@AbstractC0065Px int i, @AbstractC0065Px int i2) {
                this(i, i2, Integer.MIN_VALUE, null);
            }

            public Action(@AbstractC0065Px int i, @AbstractC0065Px int i2, int i3) {
                this(i, i2, i3, null);
            }

            public Action(@AbstractC0065Px int i, @AbstractC0065Px int i2, int i3, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@AbstractC0065Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }
            ...
            public void setDy(@AbstractC0065Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@AbstractC0065Px int i, @AbstractC0065Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
