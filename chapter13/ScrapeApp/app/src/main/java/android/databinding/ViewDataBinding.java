...
import com.android.databinding.library.C0623R;
...
public abstract class ViewDataBinding extends BaseObservable {
    ...
    protected void setRootTag(View view) {
        view.setTag(C0623R.C0626id.dataBinding, this);
    }
    ...
    public static ViewDataBinding getBinding(View v) {
        if (v != null) {
            return (ViewDataBinding) v.getTag(C0623R.C0626id.dataBinding);
        }
        return null;
    }
    ...
    /* JADX INFO: Multiple debug info for r2v10 int: [D('includeCount' int), D('lastMatchingIndex' int)] */
    /* JADX INFO: Multiple debug info for r5v4 android.view.View[]: [D('count' int), D('included' android.view.View[])] */
