...
public abstract class FragmentDetailBinding extends ViewDataBinding {
    ...
    public FragmentDetailBinding(DataBindingComponent dataBindingComponent, View view, int i, TextView textView, TextView textView2, ImageView imageView, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7, TextView textView8, TextView textView9, TextView textView10, TextView textView11) {
    ...
    public static FragmentDetailBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z, @Nullable DataBindingComponent dataBindingComponent) {
        return (FragmentDetailBinding) DataBindingUtil.inflate(layoutInflater, C0690R.layout.fragment_detail, viewGroup, z, dataBindingComponent);
    }
    ...
    public static FragmentDetailBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable DataBindingComponent dataBindingComponent) {
        return (FragmentDetailBinding) DataBindingUtil.inflate(layoutInflater, C0690R.layout.fragment_detail, null, false, dataBindingComponent);
    }
    ...
    public static FragmentDetailBinding bind(@NonNull View view, @Nullable DataBindingComponent dataBindingComponent) {
        return (FragmentDetailBinding) bind(dataBindingComponent, view, C0690R.layout.fragment_detail);
    }
}
