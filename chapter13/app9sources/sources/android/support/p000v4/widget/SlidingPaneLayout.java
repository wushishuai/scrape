...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public void setParallaxDistance(@AbstractC0065Px int i) {
        this.mParallaxBy = i;
        requestLayout();
    }
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    i11 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i16, MemoryConstants.f216GB);
                } else {
                    i11 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, MemoryConstants.f216GB);
                }
                if (layoutParams.height == -2) {
                    i12 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                } else if (layoutParams.height == -1) {
                    i12 = View.MeasureSpec.makeMeasureSpec(i3, MemoryConstants.f216GB);
                } else {
                    i12 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, MemoryConstants.f216GB);
                }
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    i8 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), MemoryConstants.f216GB);
                                } else if (layoutParams2.height == -2) {
                                    i8 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                } else if (layoutParams2.height == -1) {
                                    i8 = View.MeasureSpec.makeMeasureSpec(i3, MemoryConstants.f216GB);
                                } else {
                                    i8 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, MemoryConstants.f216GB);
                                }
                                if (z2) {
                                    int i19 = paddingLeft - (layoutParams2.leftMargin + layoutParams2.rightMargin);
                                    i6 = i17;
                                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i19, MemoryConstants.f216GB);
                                    if (i7 != i19) {
                                        childAt2.measure(makeMeasureSpec, i8);
                                    }
                                } else {
                                    i6 = i17;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(i7 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i14))) / f)), MemoryConstants.f216GB), i8);
                                }
                            } else {
                                i6 = i17;
                            }
                            ...
                            if (!z5) {
                                i9 = MemoryConstants.f216GB;
                                i10 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), MemoryConstants.f216GB);
                            } else if (layoutParams2.height == -2) {
                                i10 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                i9 = MemoryConstants.f216GB;
                            } else if (layoutParams2.height == -1) {
                                i9 = MemoryConstants.f216GB;
                                i10 = View.MeasureSpec.makeMeasureSpec(i3, MemoryConstants.f216GB);
                            } else {
                                i9 = MemoryConstants.f216GB;
                                i10 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, MemoryConstants.f216GB);
                            }
