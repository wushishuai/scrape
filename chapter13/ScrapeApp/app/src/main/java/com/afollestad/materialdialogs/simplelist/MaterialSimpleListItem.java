...
public class MaterialSimpleListItem {
    ...
    public static class Builder {
        ...
        public Builder iconPadding(@IntRange(from = 0, m54to = 2147483647L) int padding) {
            this.iconPadding = padding;
            return this;
        }

        public Builder iconPaddingDp(@IntRange(from = 0, m54to = 2147483647L) int paddingDp) {
            this.iconPadding = (int) TypedValue.applyDimension(1, (float) paddingDp, this.context.getResources().getDisplayMetrics());
            return this;
        }
