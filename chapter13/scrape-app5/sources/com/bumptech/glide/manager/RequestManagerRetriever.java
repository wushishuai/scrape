...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    private Fragment findSupportFragment(@NonNull View target, @NonNull FragmentActivity activity) {
        ...
        for (View current = target; !current.equals(activityRoot) && (result = this.tempViewToSupportFragment.get(current)) == null && (current.getParent() instanceof View); current = (View) current.getParent()) {
        }
        this.tempViewToSupportFragment.clear();
        return result;
    }
    ...
    private android.app.Fragment findFragment(@NonNull View target, @NonNull Activity activity) {
        ...
        View activityRoot = activity.findViewById(16908290);
        for (View current = target; !current.equals(activityRoot) && (result = this.tempViewToFragment.get(current)) == null && (current.getParent() instanceof View); current = (View) current.getParent()) {
        }
        this.tempViewToFragment.clear();
        return result;
    }
    ...
    @NonNull
    private SupportRequestManagerFragment getSupportRequestManagerFragment(@NonNull android.support.v4.app.FragmentManager fm, @Nullable Fragment parentHint, boolean isParentVisible) {
