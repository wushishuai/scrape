        ...
        while (true) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp.width == -2) {
                    ...
                    childWidthSpec = View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, MemoryConstants.GB);
                } else {
                    childWidthSpec = View.MeasureSpec.makeMeasureSpec(lp.width, MemoryConstants.GB);
                }
                if (lp.height == -2) {
                    childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, Integer.MIN_VALUE);
                } else if (lp.height == -1) {
                    childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, MemoryConstants.GB);
                } else {
                    childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(lp.height, MemoryConstants.GB);
                }
                ...
                if (child2.getVisibility() == i) {
                    ...
                    if (child2.getVisibility() == i) {
                        ...
                        if (!canSlide || child2 == this.mSlideableView) {
                            ...
                            if (lp2.weight > 0.0f) {
                                if (lp2.width != 0) {
                                    childHeightSpec = View.MeasureSpec.makeMeasureSpec(child2.getMeasuredHeight(), MemoryConstants.GB);
                                    ...
                                    childHeightSpec = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, MemoryConstants.GB);
                                } else {
                                    childHeightSpec = View.MeasureSpec.makeMeasureSpec(lp2.height, MemoryConstants.GB);
                                }
                                if (canSlide) {
                                    int newWidth = widthAvailable - (lp2.leftMargin + lp2.rightMargin);
                                    fixedPanelWidthLimit = fixedPanelWidthLimit2;
                                    maxLayoutHeight = maxLayoutHeight2;
                                    int childWidthSpec2 = View.MeasureSpec.makeMeasureSpec(newWidth, MemoryConstants.GB);
                                    ...
                                    fixedPanelWidthLimit = fixedPanelWidthLimit2;
                                    maxLayoutHeight = maxLayoutHeight2;
                                    child2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth + ((int) ((lp2.weight * ((float) Math.max(0, widthRemaining))) / weightSum)), MemoryConstants.GB), childHeightSpec);
                                }
                            } else {
                                fixedPanelWidthLimit = fixedPanelWidthLimit2;
                                maxLayoutHeight = maxLayoutHeight2;
                            ...
                            if (skippedFirstPass) {
                                ...
                                if (lp2.height == -2) {
                                    ...
                                    i2 = MemoryConstants.GB;
                                    childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, MemoryConstants.GB);
                                } else {
                                    i2 = MemoryConstants.GB;
                                    childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(lp2.height, MemoryConstants.GB);
                                }
                            } else {
                                childCount = childCount2;
                                i2 = MemoryConstants.GB;
                                childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(child2.getMeasuredHeight(), MemoryConstants.GB);
                            }
