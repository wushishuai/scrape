...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    @NonNull
    private SupportRequestManagerFragment getSupportRequestManagerFragment(@NonNull android.support.p000v4.app.FragmentManager fragmentManager, @Nullable Fragment fragment, boolean z) {
    ...
    @NonNull
    private RequestManager supportFragmentGet(@NonNull Context context, @NonNull android.support.p000v4.app.FragmentManager fragmentManager, @Nullable Fragment fragment, boolean z) {
