...
import com.afollestad.materialdialogs.commons.C0593R;
...
public class ColorChooserDialog extends DialogFragment implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void invalidateDynamicButtonColors() {
        MaterialDialog dialog = (MaterialDialog) getDialog();
        if (dialog != null && getBuilder().dynamicButtonColor) {
    ...
    public int getSelectedColor() {
        ...
        return DialogUtils.resolveColor(getActivity(), C0593R.attr.colorAccent, fallback);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        this.circleSize = getResources().getDimensionPixelSize(C0593R.dimen.md_colorchooser_circlesize);
        Builder builder = getBuilder();
        MaterialDialog.Builder bd = new MaterialDialog.Builder(getActivity()).title(getTitle()).autoDismiss(false).customView(C0593R.layout.md_dialog_colorchooser, false).negativeText(builder.cancelBtn).positiveText(builder.doneBtn).neutralText(builder.allowUserCustom ? builder.customBtn : 0).typeface(builder.mediumFont, builder.regularFont).onPositive(new MaterialDialog.SingleButtonCallback() { // from class: com.afollestad.materialdialogs.color.ColorChooserDialog.4
        ...
        this.grid = (GridView) v.findViewById(C0593R.C0596id.md_grid);
        if (builder.allowUserCustom) {
            this.selectedCustomColor = preselectColor;
            this.colorChooserCustomFrame = v.findViewById(C0593R.C0596id.md_colorChooserCustomFrame);
            this.customColorHex = (EditText) v.findViewById(C0593R.C0596id.md_hexInput);
            this.customColorIndicator = v.findViewById(C0593R.C0596id.md_colorIndicator);
            this.customSeekA = (SeekBar) v.findViewById(C0593R.C0596id.md_colorA);
            this.customSeekAValue = (TextView) v.findViewById(C0593R.C0596id.md_colorAValue);
            this.customSeekR = (SeekBar) v.findViewById(C0593R.C0596id.md_colorR);
            this.customSeekRValue = (TextView) v.findViewById(C0593R.C0596id.md_colorRValue);
            this.customSeekG = (SeekBar) v.findViewById(C0593R.C0596id.md_colorG);
            this.customSeekGValue = (TextView) v.findViewById(C0593R.C0596id.md_colorGValue);
            this.customSeekB = (SeekBar) v.findViewById(C0593R.C0596id.md_colorB);
            this.customSeekBValue = (TextView) v.findViewById(C0593R.C0596id.md_colorBValue);
            if (!builder.allowUserCustomAlpha) {
                v.findViewById(C0593R.C0596id.md_colorALabel).setVisibility(8);
    ...
    public void invalidate() {
        if (this.grid.getAdapter() == null) {
            ...
            this.grid.setSelector(ResourcesCompat.getDrawable(getResources(), C0593R.C0595drawable.md_transparent, null));
        } else {
    ...
    public static class Builder implements Serializable {
        ...
        int titleSub;
        @StringRes
        int doneBtn = C0593R.string.md_done_label;
        @StringRes
        int backBtn = C0593R.string.md_back_label;
        @StringRes
        int cancelBtn = C0593R.string.md_cancel_label;
        @StringRes
        int customBtn = C0593R.string.md_custom_label;
        @StringRes
        int presetsBtn = C0593R.string.md_presets_label;
    ...
    public class ColorGridAdapter extends BaseAdapter {
        ...
        public Object getItem(int position) {
            if (ColorChooserDialog.this.isInSub()) {
                return Integer.valueOf(ColorChooserDialog.this.colorsSub[ColorChooserDialog.this.topIndex()][position]);
            }
            return Integer.valueOf(ColorChooserDialog.this.colorsTop[position]);
        }
