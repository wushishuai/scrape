...
class GhostViewApi14 extends View implements GhostViewImpl {
    ...
    protected void onAttachedToWindow() {
        ...
        int[] iArr2 = {(int) (((float) iArr2[0]) - this.mView.getTranslationX()), (int) (((float) iArr2[1]) - this.mView.getTranslationY())};
    ...
    private static void setGhostView(@NonNull View view, GhostViewApi14 ghostViewApi14) {
        view.setTag(C0238R.C0241id.ghost_view, ghostViewApi14);
    }
