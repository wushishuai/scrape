        ...
        for (int i = 0; i < this.num; i++) {
            switch (i) {
                case 0:
                    ...
                    canvas.drawCircle((float) (((getMeasuredWidth() / 2) - (this.cir_x * 3)) - (((w * 3) / 3) * 2)), (float) (getMeasuredHeight() / 2), this.f81r, this.mPath);
                    break;
                case 1:
                    this.mPath.setAlpha(105);
                    canvas.drawCircle((float) (((getMeasuredWidth() / 2) - (this.cir_x * 2)) - (((w * 2) / 3) * 2)), (float) (getMeasuredHeight() / 2), this.f81r, this.mPath);
                    break;
                case 2:
                    this.mPath.setAlpha(145);
                    canvas.drawCircle((float) (((getMeasuredWidth() / 2) - (this.cir_x * 1)) - ((w / 3) * 2)), (float) (getMeasuredHeight() / 2), this.f81r, this.mPath);
                    break;
                case 3:
