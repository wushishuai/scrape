...
public class AppApplication extends BaseApplication {
    ...
    private void initCrash() {
        CaocConfig.Builder.create().backgroundMode(0).enabled(true).showErrorDetails(true).showRestartButton(true).trackActivities(true).minTimeBetweenCrashesMs(2000).errorDrawable(Integer.valueOf((int) C0691R.mipmap.ic_launcher)).restartActivity(MainActivity.class).apply();
    }
}
