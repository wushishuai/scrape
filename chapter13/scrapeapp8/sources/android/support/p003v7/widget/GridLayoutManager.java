...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    @Override // android.support.p003v7.widget.LinearLayoutManager
    ...
    @Override // android.support.p003v7.widget.LinearLayoutManager, android.support.p003v7.widget.RecyclerView.LayoutManager
    ...
    */
    void layoutChunk(android.support.p003v7.widget.RecyclerView.Recycler r26, android.support.p003v7.widget.RecyclerView.State r27, android.support.p003v7.widget.LinearLayoutManager.LayoutState r28, android.support.p003v7.widget.LinearLayoutManager.LayoutChunkResult r29) {
        /*
    ...
    /* JADX INFO: Multiple debug info for r13v12 int: [D('overlap' int), D('assignAsWeek' boolean)] */
            ...
            if (!candidate.hasFocusable() || spanGroupIndex == focusableSpanGroupIndex2) {
                ...
                if (assignAsWeek) {
                    if (candidate.hasFocusable()) {
                        ...
                        focusableWeakCandidateSpanIndex3 = focusableWeakCandidateSpanIndex4;
                    } else {
    ...
    public static final class DefaultSpanSizeLookup extends SpanSizeLookup {
        @Override // android.support.p003v7.widget.GridLayoutManager.SpanSizeLookup
