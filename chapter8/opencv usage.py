...
image_raw = cv2.imread('captcha 1.png')
...
arc_length_min, arc_length_length_max = get_arc_length_threshold(image_width, image_height)
...
for contour in contours:
    ...
    if contour_area_min < cv2.contourArea(contour) < contour_area_max and \
            arc_length_min < cv2.arcLength(contour, True) < arc_length_length_max and offset_min < x < offset_max:
