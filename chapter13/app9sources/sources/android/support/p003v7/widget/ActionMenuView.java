...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    /* JADX WARN: Removed duplicated region for block: B:136:0x0240 A[LOOP:5: B:136:0x0240->B:140:0x025f, LOOP_START, PHI: r13 
      PHI: (r13v3 int) = (r13v2 int), (r13v4 int) binds: [B:135:0x023e, B:140:0x025f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        view.measure(View.MeasureSpec.makeMeasureSpec(i * i5, MemoryConstants.f216GB), makeMeasureSpec);
        return i5;
    }
    ...
    @Override // android.support.p003v7.widget.LinearLayoutCompat, android.view.ViewGroup
    ...
    @Override // android.support.p003v7.view.menu.MenuBuilder.ItemInvoker
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
