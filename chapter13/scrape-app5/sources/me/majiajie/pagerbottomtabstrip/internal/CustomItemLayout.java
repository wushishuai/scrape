...
public class CustomItemLayout extends ViewGroup implements ItemController {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (visableChildCount != 0) {
            int childWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(widthMeasureSpec) / visableChildCount, MemoryConstants.GB);
            int childHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.max(0, (View.MeasureSpec.getSize(heightMeasureSpec) - getPaddingBottom()) - getPaddingTop()), MemoryConstants.GB);
