...
public final class FlowableConcatMap<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    public static abstract class BaseConcatMapSubscriber<T, R> extends AtomicInteger implements FlowableSubscriber<T>, ConcatMapSupport<R>, Subscription {
        ...
        @Override // p005io.reactivex.internal.operators.flowable.FlowableConcatMap.ConcatMapSupport
    ...
    public static final class ConcatMapImmediate<T, R> extends BaseConcatMapSubscriber<T, R> {
        ...
        @Override // p005io.reactivex.internal.operators.flowable.FlowableConcatMap.BaseConcatMapSubscriber
                    ...
                    if (!this.active) {
                        ...
                        try {
                            ...
                            if (d && empty) {
                                ...
                                try {
                                    Publisher<? extends R> p = (Publisher) ObjectHelper.requireNonNull(this.mapper.apply(poll), "The mapper returned a null Publisher");
