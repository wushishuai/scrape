...
public class SinaRefreshView extends FrameLayout implements IHeaderView {
    ...
    private void init() {
        View rootView = View.inflate(getContext(), C0843R.layout.view_sinaheader, null);
        this.refreshArrow = (ImageView) rootView.findViewById(C0843R.C0846id.iv_arrow);
        this.refreshTextView = (TextView) rootView.findViewById(C0843R.C0846id.f72tv);
        this.loadingView = (ImageView) rootView.findViewById(C0843R.C0846id.iv_loading);
        addView(rootView);
    }
