...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m33as(@NonNull ObservableConverter<T, ? extends R> observableConverter) {
    ...
    public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> function, boolean z) {
        return flatMap(function, z, (int) ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    }
    ...
    @CheckReturnValue
    /* renamed from: to */
    public final <R> R m32to(Function<? super Observable<T>, R> function) {
        try {
