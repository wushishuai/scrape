...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    @Override // android.support.p003v7.util.ThreadUtil
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(final ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new ThreadUtil.MainThreadCallback<T>() { // from class: android.support.v7.util.MessageThreadUtil.1
            ...
            private Runnable mMainThreadRunnable = new Runnable() { // from class: android.support.v7.util.MessageThreadUtil.1.1
                ...
                public void run() {
                    SyncQueueItem next = C04701.this.mQueue.next();
                    while (next != null) {
                        switch (next.what) {
                            case 1:
                        ...
                        next = C04701.this.mQueue.next();
                    }
                }
            };

            @Override // android.support.p003v7.util.ThreadUtil.MainThreadCallback
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(final ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new ThreadUtil.BackgroundCallback<T>() { // from class: android.support.v7.util.MessageThreadUtil.2
            ...
            private Runnable mBackgroundRunnable = new Runnable() { // from class: android.support.v7.util.MessageThreadUtil.2.1
                ...
                public void run() {
                    while (true) {
                        SyncQueueItem next = C04722.this.mQueue.next();
                        if (next != null) {
                            switch (next.what) {
                                case 1:
                                    C04722.this.mQueue.removeMessages(1);
                                    backgroundCallback.refresh(next.arg1);
                                    break;
                                case 2:
                                    C04722.this.mQueue.removeMessages(2);
                                    C04722.this.mQueue.removeMessages(3);
                            ...
                            C04722.this.mBackgroundRunning.set(false);
                            return;
                        }
                    }
                }
            ...
            @Override // android.support.p003v7.util.ThreadUtil.BackgroundCallback
