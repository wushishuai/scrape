...
public class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0456R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0456R.styleable.AlertDialog, C0456R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0456R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0456R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0456R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0456R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0456R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0456R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0456R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a.getDimensionPixelSize(C0456R.styleable.AlertDialog_buttonIconDimen, 0);
        a.recycle();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x009f, code lost:
        r1 = r9.findViewById(android.support.p003v7.appcompat.C0456R.C0459id.titleDividerNoCustom);
     */
    ...
    */
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        final View indicatorUp = this.mWindow.findViewById(C0456R.C0459id.scrollIndicatorUp);
        final View indicatorDown = this.mWindow.findViewById(C0456R.C0459id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0456R.C0459id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0456R.C0459id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0456R.C0459id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0456R.C0459id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0456R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0456R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0456R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (cursor == null) {
                    ...
                    adapter = new CursorAdapter(this.mContext, cursor, false) { // from class: android.support.v7.app.AlertController.AlertParams.2
