...
import com.android.databinding.library.baseAdapters.C0628R;
...
public class DatePickerBindingAdapter {
    ...
    public static void setListeners(DatePicker view, int year, int month, int day, DatePicker.OnDateChangedListener listener, InverseBindingListener yearChanged, InverseBindingListener monthChanged, InverseBindingListener dayChanged) {
        ...
        DateChangedListener oldListener = (DateChangedListener) ListenerUtil.getListener(view, C0628R.C0631id.onDateChanged);
        if (oldListener == null) {
            oldListener = new DateChangedListener();
            ListenerUtil.trackListener(view, oldListener, C0628R.C0631id.onDateChanged);
        }
