...
public class MovieEntity implements Parcelable {
    ...
    public String toString() {
        return String.format("MovieEntity{id=%s, name=%s, alias=%s, publishedAt=%s, cover=%s, drama=%s, categories=%s, regions=%s, score=%s, minute=%s}", Integer.valueOf(this.id), this.name, this.alias, this.publishedAt, this.cover, this.drama, this.categories, this.regions, Float.valueOf(this.score), Integer.valueOf(this.minute));
    }
