...
public class ScrollingUtil {
    ...
    public static boolean canChildScrollUp(View mChildView) {
        ...
        if (mChildView instanceof AbsListView) {
            ...
            return false;
        } else if (ViewCompat.canScrollVertically(mChildView, -1) || mChildView.getScrollY() > 0) {
            return true;
        } else {
            return false;
        }
    ...
    public static boolean isViewToTop(View view, int mTouchSlop) {
        ...
        return view != null && Math.abs(view.getScrollY()) <= mTouchSlop * 2;
    }
    ...
    public static boolean isRecyclerViewToTop(RecyclerView recyclerView) {
        if (recyclerView != null) {
            ...
            } else if ((manager instanceof StaggeredGridLayoutManager) && ((StaggeredGridLayoutManager) manager).findFirstCompletelyVisibleItemPositions(null)[0] < 1 && firstChildTop == 0) {
                return true;
            }
        }
        return false;
    ...
    private static int getRecyclerViewItemTopInset(RecyclerView.LayoutParams layoutParams) {
        try {
            ...
            return ((Rect) field.get(layoutParams)).top;
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
    ...
    public static boolean isViewGroupToBottom(ViewGroup viewGroup) {
        ...
        if (subChildView == null || subChildView.getMeasuredHeight() > viewGroup.getScrollY() + viewGroup.getHeight()) {
            return false;
        }
        return true;
    }
    ...
    public static void scrollAViewBy(View view, int height) {
        if (view instanceof RecyclerView) {
            ...
            try {
                view.getClass().getDeclaredMethod("smoothScrollBy", Integer.class, Integer.class).invoke(view, 0, Integer.valueOf(height));
            } catch (Exception e) {
