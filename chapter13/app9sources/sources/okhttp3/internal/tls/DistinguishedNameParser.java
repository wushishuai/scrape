...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f225dn;
    private int end;
    private final int length;
    private int pos;

    DistinguishedNameParser(X500Principal x500Principal) {
        this.f225dn = x500Principal.getName("RFC2253");
        this.length = this.f225dn.length();
    }
        ...
        if (i4 < this.length) {
            ...
            if (this.chars[i4] == ' ') {
                ...
                if (cArr3[i6] != '=' || i6 == this.length) {
                    throw new IllegalStateException("Unexpected end of DN: " + this.f225dn);
                }
            }
            this.pos++;
            while (true) {
    ...
    */
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f225dn);
            } else {
                i2 = c - '7';
            }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f225dn.toCharArray();
