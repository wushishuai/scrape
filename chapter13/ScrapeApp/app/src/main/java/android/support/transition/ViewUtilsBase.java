...
public class ViewUtilsBase {
    ...
    public void setTransitionAlpha(@NonNull View view, float alpha) {
        Float savedAlpha = (Float) view.getTag(C0244R.C0247id.save_non_transition_alpha);
        if (savedAlpha != null) {
    ...
    public void saveNonTransitionAlpha(@NonNull View view) {
        if (view.getTag(C0244R.C0247id.save_non_transition_alpha) == null) {
            view.setTag(C0244R.C0247id.save_non_transition_alpha, Float.valueOf(view.getAlpha()));
        }
    }

    public void clearNonTransitionAlpha(@NonNull View view) {
        if (view.getVisibility() == 0) {
            view.setTag(C0244R.C0247id.save_non_transition_alpha, null);
        }
    }
