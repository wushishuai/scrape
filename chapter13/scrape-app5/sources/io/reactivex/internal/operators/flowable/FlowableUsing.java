...
public final class FlowableUsing<T, D> extends Flowable<T> {
    ...
    public void subscribeActual(Subscriber<? super T> s) {
        try {
            ...
            try {
                ((Publisher) ObjectHelper.requireNonNull(this.sourceSupplier.apply(call), "The sourceSupplier returned a null Publisher")).subscribe(new UsingSubscriber<>(s, call, this.disposer, this.eager));
            } catch (Throwable e) {
