    ...
    */
    private int getOffset(int r6) {
        /*
            ...
            return r0
        L_0x0004:
            android.support.v7.widget.ChildHelper$Callback r1 = r5.mCallback
            int r1 = r1.getChildCount()
            r2 = r6
        L_0x000b:
            if (r2 >= r1) goto L_0x0027
            android.support.v7.widget.ChildHelper$Bucket r3 = r5.mBucket
            int r3 = r3.countOnesBefore(r2)
            int r4 = r2 - r3
            int r4 = r6 - r4
            if (r4 != 0) goto L_0x0025
        L_0x0019:
            android.support.v7.widget.ChildHelper$Bucket r0 = r5.mBucket
        ...
        L_0x0027:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.ChildHelper.getOffset(int):int");
    }
    ...
    public static class Bucket {
        ...
        boolean remove(int index) {
            ...
            long mask2 = mask - 1;
            long j = this.mData;
            this.mData = (j & mask2) | Long.rotateRight(j & (-1 ^ mask2), 1);
            Bucket bucket = this.mNext;
            if (bucket != null) {
                if (bucket.get(0)) {
                    set(63);
