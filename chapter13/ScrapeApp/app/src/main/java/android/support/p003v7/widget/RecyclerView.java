...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mViewInfoProcessCallback = new ViewInfoStore.ProcessCallback() { // from class: android.support.v7.widget.RecyclerView.4
            @Override // android.support.p003v7.widget.ViewInfoStore.ProcessCallback
        ...
        if (attrs != null) {
            TypedArray a2 = context.obtainStyledAttributes(attrs, C0464R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a2.getString(C0464R.styleable.RecyclerView_layoutManager);
            if (a2.getInt(C0464R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a2.getBoolean(C0464R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a2.getDrawable(C0464R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a2.getDrawable(C0464R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a2.getDrawable(C0464R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a2.getDrawable(C0464R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a2.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new ChildHelper.Callback() { // from class: android.support.v7.widget.RecyclerView.5
            @Override // android.support.p003v7.widget.ChildHelper.Callback
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() { // from class: android.support.v7.widget.RecyclerView.6
            @Override // android.support.p003v7.widget.AdapterHelper.Callback
    ...
    */
    boolean scrollByInternal(int r19, int r20, android.view.MotionEvent r21) {
        /*
            ...
            android.support.v7.widget.RecyclerView$Adapter r4 = r7.mAdapter
            r11 = 1
            r12 = 0
        ...
        L_0x007a:
            ...
            boolean r0 = android.support.p000v4.view.MotionEventCompat.isFromSource(r10, r0)
        ...
        L_0x00b5:
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.RecyclerView.scrollByInternal(int, int, android.view.MotionEvent):boolean");
    }

    @Override // android.view.View, android.support.p000v4.view.ScrollingView
    ...
    public void smoothScrollBy(@AbstractC0071Px int dx, @AbstractC0071Px int dy) {
        smoothScrollBy(dx, dy, null);
    }

    public void smoothScrollBy(@AbstractC0071Px int dx, @AbstractC0071Px int dy, @Nullable Interpolator interpolator) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutFrozen) {
        ...
        switch (action) {
            ...
            case 2:
                ...
                if (index >= 0) {
                    ...
                    if (this.mScrollState != 1) {
                        boolean startScroll = false;
                        if (canScrollHorizontally && Math.abs(dx2) > (i2 = this.mTouchSlop)) {
                            if (dx2 > 0) {
                                dx2 -= i2;
                            } else {
                                dx2 += i2;
                        ...
                        if (canScrollVertically && Math.abs(dy2) > (i = this.mTouchSlop)) {
                            if (dy2 > 0) {
                                dy2 -= i;
                            } else {
                                dy2 += i;
                    ...
                    if (this.mScrollState == 1) {
                        ...
                        if (scrollByInternal(i5, i3, vtev)) {
                            getParent().requestDisallowInterceptTouchEvent(true);
                        }
        ...
        if (layoutManager.isAutoMeasureEnabled()) {
            ...
            if (!measureSpecModeIsExactly && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), MemoryConstants.f216GB), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), MemoryConstants.f216GB));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(widthSpec, heightSpec);
                }
    ...
    public void setItemAnimator(@Nullable ItemAnimator animator) {
        ...
        if (itemAnimator2 != null) {
            itemAnimator2.setListener(this.mItemAnimatorListener);
        }
    }
    ...
    private View findNextViewToFocus() {
        ...
        for (int i2 = Math.min(itemCount, startFocusSearchIndex) - 1; i2 >= 0 && (nextFocus = findViewHolderForAdapterPosition(i2)) != null; i2--) {
    ...
    */
    public android.view.View findContainingItemView(@android.support.annotation.NonNull android.view.View r3) {
        ...
        L_0x0019:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.RecyclerView.findContainingItemView(android.view.View):android.view.View");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    android.support.p003v7.widget.RecyclerView.ViewHolder findViewHolderForPosition(int r7, boolean r8) {
        /*
            r6 = this;
        ...
        L_0x003a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.RecyclerView.findViewHolderForPosition(int, boolean):android.support.v7.widget.RecyclerView$ViewHolder");
    }
    ...
    public void offsetChildrenVertical(@AbstractC0071Px int dy) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i = 0; i < childCount; i++) {
    ...
    public void offsetChildrenHorizontal(@AbstractC0071Px int dx) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i = 0; i < childCount; i++) {
    ...
    public void onScrolled(@AbstractC0071Px int dx, @AbstractC0071Px int dy) {
    }
    ...
    public class ViewFlinger implements Runnable {
        ...
        ViewFlinger() {
            ...
            this.mScroller = new OverScroller(this$0.getContext(), RecyclerView.sQuinticInterpolator);
        }
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    RecyclerView recyclerView = RecyclerView.this;
                    recyclerView.scrollStep(dx, dy, recyclerView.mScrollStepConsumed);
                    hresult = RecyclerView.this.mScrollStepConsumed[0];
                    int vresult = RecyclerView.this.mScrollStepConsumed[1];
                    int overscrollX2 = dx - hresult;
                    int overscrollY2 = dy - vresult;
                    if (smoothScroller != null && !smoothScroller.isPendingInitialRun() && smoothScroller.isRunning()) {
                        int adapterSize2 = RecyclerView.this.mState.getItemCount();
                        if (adapterSize2 == 0) {
                            smoothScroller.stop();
                ...
                if (!RecyclerView.this.dispatchNestedScroll(hresult, adapterSize, overscrollX, overscrollY, null, 1) && !(overscrollX == 0 && overscrollY == 0)) {
                ...
                if (!(hresult == 0 && adapterSize == 0)) {
                    RecyclerView.this.dispatchOnScrolled(hresult, adapterSize);
                }
                if (!RecyclerView.this.awakenScrollBars()) {
                    RecyclerView.this.invalidate();
                }
                boolean fullyConsumedAny = (dx == 0 && dy == 0) || (dx != 0 && RecyclerView.this.mLayout.canScrollHorizontally() && hresult == dx) || (dy != 0 && RecyclerView.this.mLayout.canScrollVertically() && adapterSize == dy);
    ...
    public class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        @Override // android.support.p003v7.widget.RecyclerView.AdapterDataObserver
    ...
    public final class Recycler {
        ...
        public ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            if (holder2 == null) {
                ...
                if (RecyclerView.this.mAdapter.hasStableIds() && (holder2 = getScrapOrCachedViewForId(RecyclerView.this.mAdapter.getItemId(offsetPosition), type, dryRun)) != null) {
                    holder2.mPosition = offsetPosition;
                    fromScrapOrHiddenOrCache2 = true;
                }
                if (!(holder2 != null || (viewCacheExtension = this.mViewCacheExtension) == null || (view = viewCacheExtension.getViewForPositionAndType(this, position, type)) == null)) {
    ...
    public static abstract class LayoutManager {
        ...
        private final ViewBoundsCheck.Callback mHorizontalBoundCheckCallback = new ViewBoundsCheck.Callback() { // from class: android.support.v7.widget.RecyclerView.LayoutManager.1
            @Override // android.support.p003v7.widget.ViewBoundsCheck.Callback
            public int getChildCount() {
        ...
        void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mWidthMode = MemoryConstants.f216GB;
            this.mHeightMode = MemoryConstants.f216GB;
        }
        ...
        public static int getChildMeasureSpec(int parentSize, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                if (childDimension >= 0) {
                    ...
                    resultMode = MemoryConstants.f216GB;
                } else {
                    resultSize = 0;
                    resultMode = 0;
                }
        ...
        */
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0464R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0464R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0464R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0464R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0464R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }

        void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), MemoryConstants.f216GB), View.MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), MemoryConstants.f216GB));
        }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0464R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0464R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0464R.dimen.fastscroll_margin));
    }
    ...
    @Override // android.support.p000v4.view.NestedScrollingChild2
    ...
    public static abstract class SmoothScroller {
        ...
        protected abstract void onSeekTargetStep(@AbstractC0071Px int i, @AbstractC0071Px int i2, @NonNull State state, @NonNull Action action);
        ...
        public static class Action {
            ...
            public Action(@AbstractC0071Px int dx, @AbstractC0071Px int dy) {
                this(dx, dy, Integer.MIN_VALUE, null);
            }

            public Action(@AbstractC0071Px int dx, @AbstractC0071Px int dy, int duration) {
                this(dx, dy, duration, null);
            }

            public Action(@AbstractC0071Px int dx, @AbstractC0071Px int dy, int duration, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@AbstractC0071Px int dx) {
                this.mChanged = true;
                this.mDx = dx;
            }
            ...
            public void setDy(@AbstractC0071Px int dy) {
                this.mChanged = true;
                this.mDy = dy;
            }
            ...
            public void update(@AbstractC0071Px int dx, @AbstractC0071Px int dy, int duration, @Nullable Interpolator interpolator) {
                this.mDx = dx;
                this.mDy = dy;
                this.mDuration = duration;
                this.mInterpolator = interpolator;
    ...
    public static class State {
        ...
        public <T> T get(int resourceId) {
            ...
            return (T) sparseArray.get(resourceId);
        }
    ...
    public class ItemAnimatorRestoreListener implements ItemAnimator.ItemAnimatorListener {
        ...
        @Override // android.support.p003v7.widget.RecyclerView.ItemAnimator.ItemAnimatorListener
