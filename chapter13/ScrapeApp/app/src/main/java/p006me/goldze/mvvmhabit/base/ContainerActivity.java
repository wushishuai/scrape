...
public class ContainerActivity extends RxAppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0934R.layout.activity_container);
        ...
        trans.replace(C0934R.C0937id.content, fragment);
    ...
    public void onBackPressed() {
        Fragment fragment = getSupportFragmentManager().findFragmentById(C0934R.C0937id.content);
