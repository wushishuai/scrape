...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0097R.attr.snackbarButtonStyle};
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence text, int duration) {
        ...
        if (parent != null) {
            SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(parent.getContext()).inflate(hasSnackbarButtonStyleAttr(parent.getContext()) ? C0097R.layout.mtrl_layout_snackbar_include : C0097R.layout.design_layout_snackbar_include, parent, false);
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (child.getLayoutParams().width == -1) {
                    child.measure(View.MeasureSpec.makeMeasureSpec(availableWidth, MemoryConstants.f216GB), View.MeasureSpec.makeMeasureSpec(child.getMeasuredHeight(), MemoryConstants.f216GB));
                }
            }
        }
    }
