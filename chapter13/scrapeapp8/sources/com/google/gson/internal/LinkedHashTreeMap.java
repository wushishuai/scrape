...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
        ...
        if (nearest2 != null) {
            ...
            while (true) {
                if (comparableKey != null) {
                    ...
                    comparison2 = comparator.compare(key, (K) nearest2.key);
                }
                if (comparison2 == 0) {
                    return nearest2;
                }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public Iterator<Map.Entry<K, V>> iterator() {
            return new LinkedHashTreeMap<K, V>.LinkedTreeMapIterator() { // from class: com.google.gson.internal.LinkedHashTreeMap.EntrySet.1
                {
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public Iterator<K> iterator() {
            return new LinkedHashTreeMap<K, V>.LinkedTreeMapIterator() { // from class: com.google.gson.internal.LinkedHashTreeMap.KeySet.1
                {
                    LinkedHashTreeMap linkedHashTreeMap = LinkedHashTreeMap.this;
                }
