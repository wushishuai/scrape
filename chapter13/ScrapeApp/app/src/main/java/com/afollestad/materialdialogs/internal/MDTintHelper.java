...
public class MDTintHelper {
    public static void setTint(@NonNull RadioButton radioButton, @NonNull ColorStateList colors) {
        ...
        Drawable d = DrawableCompat.wrap(ContextCompat.getDrawable(radioButton.getContext(), C0583R.C0585drawable.abc_btn_radio_material));
    ...
    public static void setTint(@NonNull RadioButton radioButton, @ColorInt int color) {
        ...
        setTint(radioButton, new ColorStateList(new int[][]{new int[]{16842910, -16842912}, new int[]{16842910, 16842912}, new int[]{-16842910, -16842912}, new int[]{-16842910, 16842912}}, new int[]{DialogUtils.resolveColor(radioButton.getContext(), C0583R.attr.colorControlNormal), color, disabledColor, disabledColor}));
    }
    ...
    public static void setTint(@NonNull CheckBox box, @NonNull ColorStateList colors) {
        ...
        Drawable drawable = DrawableCompat.wrap(ContextCompat.getDrawable(box.getContext(), C0583R.C0585drawable.abc_btn_check_material));
    ...
    public static void setTint(@NonNull CheckBox box, @ColorInt int color) {
        ...
        setTint(box, new ColorStateList(new int[][]{new int[]{16842910, -16842912}, new int[]{16842910, 16842912}, new int[]{-16842910, -16842912}, new int[]{-16842910, 16842912}}, new int[]{DialogUtils.resolveColor(box.getContext(), C0583R.attr.colorControlNormal), color, disabledColor, disabledColor}));
    }
    ...
    private static ColorStateList createEditTextColorStateList(@NonNull Context context, @ColorInt int color) {
        ...
        iArr[0] = -16842910;
        states[0] = iArr;
        colors[0] = DialogUtils.resolveColor(context, C0583R.attr.colorControlNormal);
        int i = 0 + 1;
        states[i] = new int[]{-16842919, -16842908};
        colors[i] = DialogUtils.resolveColor(context, C0583R.attr.colorControlNormal);
        int i2 = i + 1;
        states[i2] = new int[0];
        colors[i2] = color;
