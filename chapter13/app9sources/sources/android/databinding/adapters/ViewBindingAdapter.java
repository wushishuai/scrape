...
import com.android.databinding.library.baseAdapters.C0627R;
...
public class ViewBindingAdapter {
    ...
    public static void setOnAttachStateChangeListener(View view, final OnViewDetachedFromWindow onViewDetachedFromWindow, final OnViewAttachedToWindow onViewAttachedToWindow) {
        View$OnAttachStateChangeListenerC00621 r2;
        if (onViewDetachedFromWindow == null && onViewAttachedToWindow == null) {
            r2 = null;
        } else {
            r2 = new View.OnAttachStateChangeListener() { // from class: android.databinding.adapters.ViewBindingAdapter.1
        ...
        View.OnAttachStateChangeListener onAttachStateChangeListener = (View.OnAttachStateChangeListener) ListenerUtil.trackListener(view, r2, C0627R.C0630id.onAttachStateChangeListener);
