...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0456R.styleable.LinearLayoutCompat, defStyleAttr, 0);
        int index = a.getInt(C0456R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (index >= 0) {
            setOrientation(index);
        }
        int index2 = a.getInt(C0456R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (index2 >= 0) {
            setGravity(index2);
        }
        boolean baselineAligned = a.getBoolean(C0456R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!baselineAligned) {
            setBaselineAligned(baselineAligned);
        }
        this.mWeightSum = a.getFloat(C0456R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = a.getInt(C0456R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = a.getBoolean(C0456R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a.getDrawable(C0456R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = a.getInt(C0456R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a.getDimensionPixelSize(C0456R.styleable.LinearLayoutCompat_dividerPadding, 0);
        a.recycle();
    }
    ...
    /* JADX INFO: Multiple debug info for r6v3 int: [D('alternativeMaxWidth' int), D('maxWidth' int)] */
    ...
    */
    ...
    /* JADX INFO: Multiple debug info for r12v2 int: [D('weightedMaxHeight' int), D('widthMode' int)] */
        ...
        while (i2 < count) {
            ...
            if (child == null) {
                ...
                if (absoluteGravity != 1) {
                    childLeft = absoluteGravity != 5 ? lp.leftMargin + paddingLeft2 : (childRight - childWidth) - lp.rightMargin;
                } else {
    ...
    */
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = -1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0456R.styleable.LinearLayoutCompat_Layout);
            this.weight = a.getFloat(C0456R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = a.getInt(C0456R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            a.recycle();
        }
