...
class ImageViewUtils {
    ...
    public static void startAnimateTransform(ImageView view) {
        if (Build.VERSION.SDK_INT < 21) {
            ...
            view.setTag(C0244R.C0247id.save_scale_type, scaleType);
            if (scaleType == ImageView.ScaleType.MATRIX) {
                view.setTag(C0244R.C0247id.save_image_matrix, view.getImageMatrix());
            } else {
        ...
        if (Build.VERSION.SDK_INT < 21) {
            animator.addListener(new AnimatorListenerAdapter() { // from class: android.support.transition.ImageViewUtils.1
                ...
                public void onAnimationEnd(Animator animation) {
                    ImageView.ScaleType scaleType = (ImageView.ScaleType) view.getTag(C0244R.C0247id.save_scale_type);
                    view.setScaleType(scaleType);
                    view.setTag(C0244R.C0247id.save_scale_type, null);
                    if (scaleType == ImageView.ScaleType.MATRIX) {
                        ImageView imageView = view;
                        imageView.setImageMatrix((Matrix) imageView.getTag(C0244R.C0247id.save_image_matrix));
                        view.setTag(C0244R.C0247id.save_image_matrix, null);
                    }
