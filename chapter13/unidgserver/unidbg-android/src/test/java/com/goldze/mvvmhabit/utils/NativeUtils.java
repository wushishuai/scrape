...
public class NativeUtils {
    ...
    public String encrypt(String string, int offset){
        DvmObject<?> result = cls.callStaticJniMethodObject(emulator,"encrypt(Ljava/lang/String;)Ljava/lang/String",vm.addGlobalObject(new StringObject(vm,string)),offset);
