...
public class LruCache<K, V> {
    ...
    */
    public void trimToSize(int r7) {
        ...
        L_0x0003:
            monitor-enter(r6)
            int r3 = r6.size     // Catch: all -> 0x0073
            if (r3 < 0) goto L_0x0054
            java.util.LinkedHashMap<K, V> r3 = r6.map     // Catch: all -> 0x0073
            boolean r3 = r3.isEmpty()     // Catch: all -> 0x0073
        ...
        L_0x0021:
            java.util.LinkedHashMap<K, V> r3 = r6.map     // Catch: all -> 0x0073
            java.util.Set r3 = r3.entrySet()     // Catch: all -> 0x0073
            java.util.Iterator r3 = r3.iterator()     // Catch: all -> 0x0073
            java.lang.Object r3 = r3.next()     // Catch: all -> 0x0073
            java.util.Map$Entry r3 = (java.util.Map.Entry) r3     // Catch: all -> 0x0073
            java.lang.Object r1 = r3.getKey()     // Catch: all -> 0x0073
            java.lang.Object r2 = r3.getValue()     // Catch: all -> 0x0076
        ...
        L_0x0054:
            ...
            java.lang.Class r4 = r6.getClass()     // Catch: all -> 0x0073
            java.lang.String r4 = r4.getName()     // Catch: all -> 0x0073
