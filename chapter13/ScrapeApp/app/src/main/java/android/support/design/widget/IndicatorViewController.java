...
public final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputView) {
        ...
        this.captionTranslationYPx = (float) this.context.getResources().getDimensionPixelSize(C0097R.dimen.design_textinput_caption_translate_y);
    }
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.errorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.errorView.setId(C0097R.C0100id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean enabled) {
        if (this.helperTextEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.helperTextView.setId(C0097R.C0100id.textinput_helper_text);
                Typeface typeface = this.typeface;
                if (typeface != null) {
