...
public class FragmentDetailBindingImpl extends FragmentDetailBinding {
    ...
    static {
        sViewsWithIds.put(R.id.categories_key, 8);
        sViewsWithIds.put(R.id.score_key, 9);
        sViewsWithIds.put(R.id.minute_key, 10);
        sViewsWithIds.put(R.id.published_at_key, 11);
        sViewsWithIds.put(R.id.drama_key, 12);
    }
    ...
    protected void executeBindings() {
        ...
        if (j2 != 0) {
            ...
            ViewAdapter.setImageUri(this.cover, str5, R.mipmap.ic_launcher_round);
