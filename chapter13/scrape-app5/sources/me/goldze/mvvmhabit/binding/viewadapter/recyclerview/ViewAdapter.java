...
public class ViewAdapter {
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: me.goldze.mvvmhabit.binding.viewadapter.recyclerview.ViewAdapter.1
            ...
            public void onScrolled(RecyclerView recyclerView2, int dx, int dy) {
                ...
                if (bindingCommand != null) {
                    bindingCommand.execute(new ScrollDataWrapper((float) dx, (float) dy, this.state));
                }
            }
    ...
    public static class OnScrollListener extends RecyclerView.OnScrollListener {
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (visibleItemCount + layoutManager.findFirstVisibleItemPosition() >= layoutManager.getItemCount() && this.onLoadMoreCommand != null) {
