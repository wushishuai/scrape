...
public class RetrofitClient {
    ...
    public static String baseUrl = "https://app8.scrape.center";
    ...
    public static <T> T execute(Observable<T> observable, Observer<T> subscriber) {
        observable.subscribeOn(Schedulers.m27io()).unsubscribeOn(Schedulers.m27io()).observeOn(AndroidSchedulers.mainThread()).subscribe(subscriber);
        return null;
    }
}
