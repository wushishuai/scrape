...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0452R.styleable.ActivityChooserView, i, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(C0452R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0452R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        ...
        FrameLayout frameLayout = (FrameLayout) findViewById(C0452R.C0455id.expand_activities_button);
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) frameLayout.findViewById(C0452R.C0455id.image);
    ...
    */
    void showPopupUnchecked(int r6) {
        ...
        L_0x0078:
            ...
            int r3 = android.support.p003v7.appcompat.C0452R.string.abc_activitychooserview_choose_application
        ...
        L_0x0096:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.ActivityChooserView.showPopupUnchecked(int):void");
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mDefaultActivityButton.getVisibility() != 0) {
            i2 = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), MemoryConstants.f216GB);
        }
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            switch (getItemViewType(i)) {
                case 0:
                    if (view == null || view.getId() != C0452R.C0455id.list_item) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0452R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    }
                    PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                    ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
                    ((ImageView) view.findViewById(C0452R.C0455id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
                    ((TextView) view.findViewById(C0452R.C0455id.title)).setText(resolveInfo.loadLabel(packageManager));
                ...
                case 1:
                    ...
                    View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0452R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    inflate.setId(1);
                    ((TextView) inflate.findViewById(C0452R.C0455id.title)).setText(ActivityChooserView.this.getContext().getString(C0452R.string.abc_activity_chooser_view_see_all));
                    return inflate;
                default:
                    throw new IllegalArgumentException();
            }
