...
public abstract class ViewDataBinding extends BaseObservable {
    ...
    public static ViewDataBinding getBinding(View view) {
        if (view != null) {
            return (ViewDataBinding) view.getTag(C0622R.C0625id.dataBinding);
        }
        return null;
    }
    ...
    protected static <T> T getFromList(android.support.p000v4.util.LongSparseArray<T> longSparseArray, int i) {
        if (longSparseArray == null || i < 0) {
            return null;
        }
        return longSparseArray.get((long) i);
    ...
    protected static <T> void setTo(android.support.p000v4.util.LongSparseArray<T> longSparseArray, int i, T t) {
        if (longSparseArray != null && i >= 0 && i < longSparseArray.size()) {
            longSparseArray.put((long) i, t);
        }
    }
