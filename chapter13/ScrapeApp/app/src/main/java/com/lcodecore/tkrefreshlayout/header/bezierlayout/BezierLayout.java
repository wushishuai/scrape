...
public class BezierLayout extends FrameLayout implements IHeaderView {
    ...
    private void init(AttributeSet attrs) {
        this.headView = LayoutInflater.from(getContext()).inflate(C0844R.layout.view_bezier, (ViewGroup) null);
        this.waveView = (WaveView) this.headView.findViewById(C0844R.C0847id.draweeView);
        this.rippleView = (RippleView) this.headView.findViewById(C0844R.C0847id.ripple);
        this.f77r1 = (RoundDotView) this.headView.findViewById(C0844R.C0847id.round1);
        this.f78r2 = (RoundProgressView) this.headView.findViewById(C0844R.C0847id.round2);
    ...
    public void onPullingDown(float fraction, float maxHeadHeight, float headHeight) {
        ...
        this.f77r1.setCir_x((int) (limitValue(1.0f, fraction) * 30.0f));
    ...
    public void startAnim(float maxHeadHeight, float headHeight) {
        ...
        this.circleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.lcodecore.tkrefreshlayout.header.bezierlayout.BezierLayout.3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator animation) {
                BezierLayout.this.f77r1.setCir_x((int) ((-((Float) animation.getAnimatedValue()).floatValue()) * 40.0f));
