...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public static <T> Flowable<T> merge(Publisher<? extends MaybeSource<? extends T>> sources) {
        return merge(sources, (int) ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    }
    ...
    public static <T> Flowable<T> mergeDelayError(Publisher<? extends MaybeSource<? extends T>> sources) {
        return mergeDelayError(sources, (int) ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    }
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m35as(@NonNull MaybeConverter<T, ? extends R> converter) {
