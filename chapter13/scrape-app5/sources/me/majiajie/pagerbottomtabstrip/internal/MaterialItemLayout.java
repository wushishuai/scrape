...
public class MaterialItemLayout extends ViewGroup implements ItemController {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightSpec = View.MeasureSpec.makeMeasureSpec(this.MATERIAL_BOTTOM_NAVIGATION_ITEM_HEIGHT, MemoryConstants.GB);
        if (this.mHideTitle) {
        ...
        for (int i4 = 0; i4 < count; i4++) {
            ...
            if (child.getVisibility() != 8) {
                child.measure(View.MeasureSpec.makeMeasureSpec(this.mTempChildWidths[i4], MemoryConstants.GB), heightSpec);
    ...
    private void addOvalColor(int color, float x, float y) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: me.majiajie.pagerbottomtabstrip.internal.MaterialItemLayout.2
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                oval.r = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
            }
        });
