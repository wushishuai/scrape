...
public class MaterialEditTextPreference extends EditTextPreference {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.color = DialogUtils.resolveColor(context, R.attr.md_widget_color, DialogUtils.resolveColor(context, R.attr.colorAccent, fallback));
    ...
    protected void showDialog(Bundle state) {
        ...
        View layout = LayoutInflater.from(getContext()).inflate(R.layout.md_stub_inputpref, (ViewGroup) null);
