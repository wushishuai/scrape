...
import p006me.goldze.mvvmhabit.base.ContainerActivity;
...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    @Override // android.support.p000v4.app.FragmentManager
    ...
    */
    public void moveToState(android.support.p000v4.app.Fragment r15, int r16, int r17, int r18, boolean r19) {
        /*
    ...
    private void animateRemoveFragment(@NonNull final Fragment fragment, @NonNull AnimationOrAnimator anim, int newState) {
        ...
        if (anim.animation != null) {
            ...
            animation.setAnimationListener(new AnimationListenerWrapper(getAnimationListener(animation)) { // from class: android.support.v4.app.FragmentManagerImpl.2
                @Override // android.support.p000v4.app.FragmentManagerImpl.AnimationListenerWrapper, android.view.animation.Animation.AnimationListener
                public void onAnimationEnd(Animation animation2) {
                    super.onAnimationEnd(animation2);
                    container.post(new Runnable() { // from class: android.support.v4.app.FragmentManagerImpl.2.1
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        if (fragment.mView != null) {
            ...
            if (anim == null || anim.animator == null) {
                ...
                if (!fragment.mHidden) {
                    ...
                    anim.animator.addListener(new AnimatorListenerAdapter() { // from class: android.support.v4.app.FragmentManagerImpl.4
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void enqueueAction(android.support.p000v4.app.FragmentManagerImpl.OpGenerator r3, boolean r4) {
        /*
            r2 = this;
        ...
        L_0x0005:
            ...
            android.support.v4.app.FragmentHostCallback r0 = r2.mHost     // Catch: all -> 0x0030
            if (r0 != 0) goto L_0x000f
            goto L_0x0024
        L_0x000f:
            java.util.ArrayList<android.support.v4.app.FragmentManagerImpl$OpGenerator> r0 = r2.mPendingActions     // Catch: all -> 0x0030
        ...
        L_0x0030:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.app.FragmentManagerImpl.enqueueAction(android.support.v4.app.FragmentManagerImpl$OpGenerator, boolean):void");
    }
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        String fname;
        Fragment fragment;
        if (!ContainerActivity.FRAGMENT.equals(name)) {
            return null;
        }
    ...
    private class PopBackStackState implements OpGenerator {
        ...
        @Override // android.support.p000v4.app.FragmentManagerImpl.OpGenerator
    ...
    public static class StartEnterTransitionListener implements Fragment.OnStartEnterTransitionListener {
        ...
        @Override // android.support.p000v4.app.Fragment.OnStartEnterTransitionListener
