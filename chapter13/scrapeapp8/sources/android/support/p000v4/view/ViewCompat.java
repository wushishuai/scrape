...
public class ViewCompat {
    ...
    public static void setPaddingRelative(@NonNull View view, @AbstractC0065Px int start, @AbstractC0065Px int top, @AbstractC0065Px int end, @AbstractC0065Px int bottom) {
        if (Build.VERSION.SDK_INT >= 17) {
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View v, @NonNull OnUnhandledKeyEventListenerCompat listener) {
        if (Build.VERSION.SDK_INT >= 28) {
            Map<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (Map) v.getTag(C0070R.C0073id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                viewListeners = new ArrayMap<>();
                v.setTag(C0070R.C0073id.tag_unhandled_key_listeners, viewListeners);
            }
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners2 = (ArrayList) v.getTag(C0070R.C0073id.tag_unhandled_key_listeners);
        if (viewListeners2 == null) {
            viewListeners2 = new ArrayList<>();
            v.setTag(C0070R.C0073id.tag_unhandled_key_listeners, viewListeners2);
        }
    ...
    public static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m49at(View root) {
            UnhandledKeyEventManager manager = (UnhandledKeyEventManager) root.getTag(C0070R.C0073id.tag_unhandled_key_event_manager);
            if (manager != null) {
                return manager;
            }
            UnhandledKeyEventManager manager2 = new UnhandledKeyEventManager();
            root.setTag(C0070R.C0073id.tag_unhandled_key_event_manager, manager2);
            return manager2;
        }
        ...
        private boolean onUnhandledKeyEvent(@NonNull View v, @NonNull KeyEvent event) {
            ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) v.getTag(C0070R.C0073id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                return false;
            }
