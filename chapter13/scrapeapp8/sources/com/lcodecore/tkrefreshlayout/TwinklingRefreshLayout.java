...
public class TwinklingRefreshLayout extends RelativeLayout implements PullListener, NestedScrollingChild {
    ...
    public TwinklingRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0843R.styleable.TwinklingRefreshLayout, defStyleAttr, 0);
        try {
            this.mMaxHeadHeight = (float) a.getDimensionPixelSize(C0843R.styleable.TwinklingRefreshLayout_tr_max_head_height, DensityUtil.dp2px(context, 120.0f));
            this.mHeadHeight = (float) a.getDimensionPixelSize(C0843R.styleable.TwinklingRefreshLayout_tr_head_height, DensityUtil.dp2px(context, 80.0f));
            this.mMaxBottomHeight = (float) a.getDimensionPixelSize(C0843R.styleable.TwinklingRefreshLayout_tr_max_bottom_height, DensityUtil.dp2px(context, 120.0f));
            this.mBottomHeight = (float) a.getDimensionPixelSize(C0843R.styleable.TwinklingRefreshLayout_tr_bottom_height, DensityUtil.dp2px(context, 60.0f));
            this.mOverScrollHeight = (float) a.getDimensionPixelSize(C0843R.styleable.TwinklingRefreshLayout_tr_overscroll_height, (int) this.mHeadHeight);
            this.enableRefresh = a.getBoolean(C0843R.styleable.TwinklingRefreshLayout_tr_enable_refresh, true);
            this.enableLoadmore = a.getBoolean(C0843R.styleable.TwinklingRefreshLayout_tr_enable_loadmore, true);
            this.isPureScrollModeOn = a.getBoolean(C0843R.styleable.TwinklingRefreshLayout_tr_pureScrollMode_on, false);
            this.isOverScrollTopShow = a.getBoolean(C0843R.styleable.TwinklingRefreshLayout_tr_overscroll_top_show, true);
            this.isOverScrollBottomShow = a.getBoolean(C0843R.styleable.TwinklingRefreshLayout_tr_overscroll_bottom_show, true);
            this.enableOverScroll = a.getBoolean(C0843R.styleable.TwinklingRefreshLayout_tr_enable_overscroll, true);
            this.floatRefresh = a.getBoolean(C0843R.styleable.TwinklingRefreshLayout_tr_floatRefresh, false);
            this.autoLoadMore = a.getBoolean(C0843R.styleable.TwinklingRefreshLayout_tr_autoLoadMore, false);
            this.enableKeepIView = a.getBoolean(C0843R.styleable.TwinklingRefreshLayout_tr_enable_keepIView, true);
            this.showRefreshingWhenOverScroll = a.getBoolean(C0843R.styleable.TwinklingRefreshLayout_tr_showRefreshingWhenOverScroll, true);
            this.showLoadingWhenOverScroll = a.getBoolean(C0843R.styleable.TwinklingRefreshLayout_tr_showLoadingWhenOverScroll, true);
            a.recycle();
    ...
    private void addHeader() {
        ...
        extraHeadLayout.setId(C0843R.C0846id.ex_header);
        addView(extraHeadLayout, new RelativeLayout.LayoutParams(-1, -2));
    ...
    private void initGestureDetector() {
        this.listener = new OnGestureListener() { // from class: com.lcodecore.tkrefreshlayout.TwinklingRefreshLayout.1
            ...
            public void onScroll(MotionEvent downEvent, MotionEvent currentEvent, float distanceX, float distanceY) {
                TwinklingRefreshLayout.this.decorator.onFingerScroll(downEvent, currentEvent, distanceX, distanceY, TwinklingRefreshLayout.this.f74vx, TwinklingRefreshLayout.this.f75vy);
            }
        ...
        switch (action & 255) {
            ...
            case 1:
                ...
                if (Math.abs(this.f75vy) > ((float) this.mMinimumFlingVelocity) || Math.abs(this.f74vx) > ((float) this.mMinimumFlingVelocity)) {
                    listener.onFling(this.mCurrentDownEvent, ev, this.f74vx, this.f75vy);
                    isFling = true;
                }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        return this.decorator.interceptTouchEvent(ev) || super.onInterceptTouchEvent(ev);
    }

    @Override // android.view.View
    public boolean onTouchEvent(MotionEvent e) {
        return this.decorator.dealTouchEvent(e) || super.onTouchEvent(e);
    }
                ...
                case 2:
                    ...
                    if (index >= 0) {
                        ...
                        if (this.mIsBeingDragged) {
                            ...
                            if (dispatchNestedScroll(0, 0, 0, dy + 0, iArr7)) {
                                int i2 = this.mLastTouchX;
                                int[] iArr8 = this.mScrollOffset;
                                this.mLastTouchX = i2 - iArr8[0];
                                this.mLastTouchY -= iArr8[1];
                                vtev.offsetLocation((float) iArr8[0], (float) iArr8[1]);
    ...
    public void setMaxHeadHeight(float maxHeightDp) {
        this.mMaxHeadHeight = (float) DensityUtil.dp2px(getContext(), maxHeightDp);
    }

    public void setHeaderHeight(float headHeightDp) {
        this.mHeadHeight = (float) DensityUtil.dp2px(getContext(), headHeightDp);
    }

    public void setMaxBottomHeight(float maxBottomHeight) {
        this.mMaxBottomHeight = (float) DensityUtil.dp2px(getContext(), maxBottomHeight);
    }

    public void setBottomHeight(float bottomHeightDp) {
        this.mBottomHeight = (float) DensityUtil.dp2px(getContext(), bottomHeightDp);
    }
    ...
    public void setOverScrollHeight(float overScrollHeightDp) {
        this.mOverScrollHeight = (float) DensityUtil.dp2px(getContext(), overScrollHeightDp);
    }
    ...
    public class CoContext {
        ...
        public CoContext() {
            TwinklingRefreshLayout.this = this$0;
        }
