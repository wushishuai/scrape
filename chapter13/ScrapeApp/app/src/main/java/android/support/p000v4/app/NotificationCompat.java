...
import android.support.compat.C0076R;
...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap icon) {
            ...
            int maxWidth = res.getDimensionPixelSize(C0076R.dimen.compat_notification_large_icon_max_width);
            int maxHeight = res.getDimensionPixelSize(C0076R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0076R.C0078drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0076R.C0079id.notification_main_column);
            outerView.addView(C0076R.C0079id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0076R.C0079id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C0076R.C0079id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0076R.C0079id.title, 8);
            outerView.setViewVisibility(C0076R.C0079id.text2, 8);
            outerView.setViewVisibility(C0076R.C0079id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0076R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0076R.dimen.notification_top_pad_large_text);
    ...
    public static class MessagingStyle extends Style {
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            sb.append((CharSequence) "  ").append(bidi.unicodeWrap(message.getText() == null ? "" : message.getText()));
            return sb;
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            RemoteViews remoteViews = applyStandardTemplate(true, C0076R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0076R.C0079id.actions);
            boolean actionsVisible = false;
            if (showActions && this.mBuilder.mActions != null && (numActions = Math.min(this.mBuilder.mActions.size(), 3)) > 0) {
                actionsVisible = true;
                for (int i = 0; i < numActions; i++) {
                    remoteViews.addView(C0076R.C0079id.actions, generateActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (!actionsVisible) {
                actionVisibility = 8;
            }
            remoteViews.setViewVisibility(C0076R.C0079id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0076R.C0079id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0076R.layout.notification_action_tombstone : C0076R.layout.notification_action);
            button.setImageViewBitmap(C0076R.C0079id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0076R.C0077color.notification_action_color_filter)));
            button.setTextViewText(C0076R.C0079id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0076R.C0079id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0076R.C0079id.action_container, action.title);
            }
            return button;
        }
    }
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle b) {
            ...
            if (remoteInput != null) {
                remoteInputCompat = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), remoteInput.getExtras(), null);
            }
