...
import p005io.reactivex.internal.operators.completable.CompletableTakeUntilCompletable;
...
import p005io.reactivex.internal.operators.mixed.CompletableAndThenObservable;
import p005io.reactivex.internal.operators.mixed.CompletableAndThenPublisher;
...
public abstract class Completable implements CompletableSource {
    ...
    public static Completable merge(Publisher<? extends CompletableSource> sources) {
        return merge0(sources, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, false);
    }
    ...
    public static Completable mergeDelayError(Publisher<? extends CompletableSource> sources) {
        return merge0(sources, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, true);
    }
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m39as(@NonNull CompletableConverter<? extends R> converter) {
    ...
    @Override // p005io.reactivex.CompletableSource
    @SchedulerSupport(SchedulerSupport.NONE)
