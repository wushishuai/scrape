    ...
    public static class PathDataNode {
            ...
            while (k2 < val.length) {
                switch (cmd) {
                    ...
                    case 't':
                        ...
                        float ctrlPointX7 = currentX2 + reflectiveCtrlPointX4;
        ...
        private static void arcToBezier(Path p, double cx, double cy, double a, double b, double e1x, double e1y, double theta, double start, double sweep) {
            ...
            while (i < numSegments) {
                ...
                p.rLineTo(0.0f, 0.0f);
                p.cubicTo((float) (e1x2 + (alpha * ep1x)), (float) (e1y2 + (alpha * ep1y2)), (float) (e2x - (alpha * ep2x)), (float) (e2y - (alpha * ep2y)), (float) e2x, (float) e2y);
                eta1 = eta2;
                e1x2 = e2x;
                e1y2 = e2y;
                ep1x = ep2x;
