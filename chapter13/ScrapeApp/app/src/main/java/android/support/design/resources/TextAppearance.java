...
public class TextAppearance {
    ...
    public TextAppearance(Context context, @StyleRes int id) {
        TypedArray a = context.obtainStyledAttributes(id, C0097R.styleable.TextAppearance);
        this.textSize = a.getDimension(C0097R.styleable.TextAppearance_android_textSize, 0.0f);
        this.textColor = MaterialResources.getColorStateList(context, a, C0097R.styleable.TextAppearance_android_textColor);
        this.textColorHint = MaterialResources.getColorStateList(context, a, C0097R.styleable.TextAppearance_android_textColorHint);
        this.textColorLink = MaterialResources.getColorStateList(context, a, C0097R.styleable.TextAppearance_android_textColorLink);
        this.textStyle = a.getInt(C0097R.styleable.TextAppearance_android_textStyle, 0);
        this.typeface = a.getInt(C0097R.styleable.TextAppearance_android_typeface, 1);
        int fontFamilyIndex = MaterialResources.getIndexWithValue(a, C0097R.styleable.TextAppearance_fontFamily, C0097R.styleable.TextAppearance_android_fontFamily);
        this.fontFamilyResourceId = a.getResourceId(fontFamilyIndex, 0);
        this.fontFamily = a.getString(fontFamilyIndex);
        this.textAllCaps = a.getBoolean(C0097R.styleable.TextAppearance_textAllCaps, false);
        this.shadowColor = MaterialResources.getColorStateList(context, a, C0097R.styleable.TextAppearance_android_shadowColor);
        this.shadowDx = a.getFloat(C0097R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.shadowDy = a.getFloat(C0097R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.shadowRadius = a.getFloat(C0097R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        a.recycle();
    }
