...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public void setSlingshotDistance(@AbstractC0065Px int i) {
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        C04184 r0 = new Animation() { // from class: android.support.v4.widget.SwipeRefreshLayout.4
            @Override // android.view.animation.Animation
            public void applyTransformation(float f, Transformation transformation) {
                CircularProgressDrawable circularProgressDrawable = SwipeRefreshLayout.this.mProgress;
                int i3 = i;
                circularProgressDrawable.setAlpha((int) (((float) i3) + (((float) (i2 - i3)) * f)));
            }
        };
        r0.setDuration(300);
    ...
    public void onMeasure(int i, int i2) {
        ...
        View view = this.mTarget;
        if (view != null) {
            view.measure(View.MeasureSpec.makeMeasureSpec((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), MemoryConstants.f216GB), View.MeasureSpec.makeMeasureSpec((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), MemoryConstants.f216GB));
            this.mCircleView.measure(View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, MemoryConstants.f216GB), View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, MemoryConstants.f216GB));
            this.mCircleViewIndex = -1;
    ...
    private void finishSpinner(float f) {
        ...
        animationAnimation$AnimationListenerC04195 r0 = null;
        if (!this.mScale) {
            r0 = new Animation.AnimationListener() { // from class: android.support.v4.widget.SwipeRefreshLayout.5
                @Override // android.view.animation.Animation.AnimationListener
                public void onAnimationRepeat(Animation animation) {
                }
