...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void setNonPrimaryAlpha(@FloatRange(from = 0.0d, m55to = 1.0d) float alpha) {
    ...
    /* JADX INFO: Multiple debug info for r6v1 int: [D('currRight' int), D('halfCurrWidth' int)] */
    public void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        textView.layout(currLeft, prevTop2, halfCurrWidth2, prevTop2 + textView.getMeasuredHeight());
