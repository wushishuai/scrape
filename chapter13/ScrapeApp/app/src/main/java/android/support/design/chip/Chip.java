...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate {
    ...
    public Chip(Context context, AttributeSet attrs) {
        this(context, attrs, C0097R.attr.chipStyle);
    }
    ...
    public Chip(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ChipDrawable drawable = ChipDrawable.createFromAttributes(context, attrs, defStyleAttr, C0097R.style.Widget_MaterialComponents_Chip_Action);
    ...
    public class ChipTouchHelper extends ExploreByTouchHelper {
        ...
        @Override // android.support.p000v4.widget.ExploreByTouchHelper
        ...
        protected void onPopulateNodeForVirtualView(int virtualViewId, AccessibilityNodeInfoCompat node) {
            if (Chip.this.hasCloseIcon()) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i = C0097R.string.mtrl_chip_close_icon_content_description;
