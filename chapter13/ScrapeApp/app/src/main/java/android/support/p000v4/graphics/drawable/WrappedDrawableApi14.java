...
public class WrappedDrawableApi14 extends Drawable implements Drawable.Callback, WrappedDrawable, TintAwareDrawable {
    ...
    public WrappedDrawableApi14(@NonNull DrawableWrapperState state, @Nullable Resources res) {
        this.mState = state;
    ...
    @Override // android.support.p000v4.graphics.drawable.WrappedDrawable
    ...
    public static abstract class DrawableWrapperState extends Drawable.ConstantState {
        ...
        public DrawableWrapperState(@Nullable DrawableWrapperState orig, @Nullable Resources res) {
            this.mTint = null;
