...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C0097R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C0097R.C0099drawable.design_bottom_navigation_item_background);
        this.defaultMargin = res.getDimensionPixelSize(C0097R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0097R.C0100id.icon);
        this.smallLabel = (TextView) findViewById(C0097R.C0100id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0097R.C0100id.largeLabel);
