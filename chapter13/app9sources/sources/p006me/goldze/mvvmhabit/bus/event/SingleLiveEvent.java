...
/* renamed from: me.goldze.mvvmhabit.bus.event.SingleLiveEvent */
...
public class SingleLiveEvent<T> extends MutableLiveData<T> {
    ...
    public void observe(LifecycleOwner lifecycleOwner, final Observer<T> observer) {
        ...
        super.observe(lifecycleOwner, new Observer<T>() { // from class: me.goldze.mvvmhabit.bus.event.SingleLiveEvent.1
