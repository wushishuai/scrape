...
/* renamed from: me.majiajie.pagerbottomtabstrip.item.OnlyIconMaterialItemView */
...
public class OnlyIconMaterialItemView extends BaseTabItem {
    ...
    public OnlyIconMaterialItemView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C1029R.layout.item_material_only_icon, (ViewGroup) this, true);
        this.mIcon = (ImageView) findViewById(C1029R.C1031id.icon);
        this.mMessages = (RoundMessageView) findViewById(C1029R.C1031id.messages);
    }
    ...
    public void initialization(String title, Drawable drawable, Drawable checkedDrawable, int color, int checkedColor) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            setBackgroundResource(C1029R.C1030drawable.material_item_background);
        }
    }
