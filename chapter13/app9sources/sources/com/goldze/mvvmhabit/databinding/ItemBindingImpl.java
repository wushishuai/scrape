...
import p006me.goldze.mvvmhabit.binding.viewadapter.view.ViewAdapter;
...
public class ItemBindingImpl extends ItemBinding {
    ...
    private ItemBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (TextView) objArr[3], (TextView) objArr[4], (TextView) objArr[2]);
        this.mDirtyFlags = -1;
    ...
    protected void executeBindings() {
        ...
        if (j2 != 0) {
            p006me.goldze.mvvmhabit.binding.viewadapter.image.ViewAdapter.setImageUri(this.mboundView1, str4, 0);
