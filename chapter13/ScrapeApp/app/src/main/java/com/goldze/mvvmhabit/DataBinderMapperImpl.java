...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    static {
        INTERNAL_LAYOUT_ID_LOOKUP.put(C0691R.layout.activity_main, 1);
        INTERNAL_LAYOUT_ID_LOOKUP.put(C0691R.layout.fragment_detail, 2);
        INTERNAL_LAYOUT_ID_LOOKUP.put(C0691R.layout.fragment_index, 3);
        INTERNAL_LAYOUT_ID_LOOKUP.put(C0691R.layout.item, 4);
    }
    ...
    public List<DataBinderMapper> collectDependencies() {
        ...
        arrayList.add(new p006me.goldze.mvvmhabit.DataBinderMapperImpl());
        return arrayList;
    }
    ...
    private static class InnerLayoutIdLookup {
        ...
        static {
            sKeys.put("layout/activity_main_0", Integer.valueOf((int) C0691R.layout.activity_main));
            sKeys.put("layout/fragment_detail_0", Integer.valueOf((int) C0691R.layout.fragment_detail));
            sKeys.put("layout/fragment_index_0", Integer.valueOf((int) C0691R.layout.fragment_index));
            sKeys.put("layout/item_0", Integer.valueOf((int) C0691R.layout.item));
        }
    }
}
