...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public BottomAppBar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0091R.attr.bottomAppBarStyle);
    }
    ...
    public BottomAppBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0091R.styleable.BottomAppBar, defStyleAttr, C0091R.style.Widget_MaterialComponents_BottomAppBar, new int[0]);
        ColorStateList backgroundTint = MaterialResources.getColorStateList(context, a, C0091R.styleable.BottomAppBar_backgroundTint);
        this.fabAlignmentMode = a.getInt(C0091R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.hideOnScroll = a.getBoolean(C0091R.styleable.BottomAppBar_hideOnScroll, false);
        a.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C0091R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
        this.topEdgeTreatment = new BottomAppBarTopEdgeTreatment((float) a.getDimensionPixelOffset(C0091R.styleable.BottomAppBar_fabCradleMargin, 0), (float) a.getDimensionPixelOffset(C0091R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0), (float) a.getDimensionPixelOffset(C0091R.styleable.BottomAppBar_fabCradleVerticalOffset, 0));
    ...
    void setFabDiameter(@AbstractC0065Px int diameter) {
