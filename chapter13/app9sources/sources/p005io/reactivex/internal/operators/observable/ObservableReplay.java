...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T>, ResettableConnectable {
    ...
    public static <T> ConnectableObservable<T> create(ObservableSource<T> observableSource, long j, TimeUnit timeUnit, Scheduler scheduler) {
        return create(observableSource, j, timeUnit, scheduler, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    }
    ...
    public static final class Replay<T> extends ConnectableObservable<T> {
        ...
        Replay(ConnectableObservable<T> connectableObservable, Observable<T> observable) {
            this.f158co = connectableObservable;
            this.observable = observable;
        }

        @Override // p005io.reactivex.observables.ConnectableObservable
        public void connect(Consumer<? super Disposable> consumer) {
            this.f158co.connect(consumer);
        }
