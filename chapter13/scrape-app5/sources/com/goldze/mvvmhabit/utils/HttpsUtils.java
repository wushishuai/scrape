...
public class HttpsUtils {
    public static X509TrustManager UnSafeTrustManager = new X509TrustManager() { // from class: com.goldze.mvvmhabit.utils.HttpsUtils.1
    ...
    public static HostnameVerifier UnSafeHostnameVerifier = new HostnameVerifier() { // from class: com.goldze.mvvmhabit.utils.HttpsUtils.2
    ...
    private static SSLParams getSslSocketFactoryBase(X509TrustManager x509TrustManager, InputStream inputStream, String str, InputStream... inputStreamArr) {
        ...
        try {
            ...
            instance.init(prepareKeyManager, new TrustManager[]{x509TrustManager}, null);
