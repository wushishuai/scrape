...
public class MaterialItemLayout extends ViewGroup implements ItemController {
    ...
    public MaterialItemLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.MATERIAL_BOTTOM_NAVIGATION_ACTIVE_ITEM_MAX_WIDTH = res.getDimensionPixelSize(C1029R.dimen.material_bottom_navigation_active_item_max_width);
        this.MATERIAL_BOTTOM_NAVIGATION_ITEM_MAX_WIDTH = res.getDimensionPixelSize(C1029R.dimen.material_bottom_navigation_item_max_width);
        this.MATERIAL_BOTTOM_NAVIGATION_ITEM_MIN_WIDTH = res.getDimensionPixelSize(C1029R.dimen.material_bottom_navigation_item_min_width);
        this.MATERIAL_BOTTOM_NAVIGATION_ITEM_HEIGHT = res.getDimensionPixelSize(C1029R.dimen.material_bottom_navigation_height);
        ...
        if ((mode & 2) > 0) {
            ...
            for (int i = 0; i < this.mItems.size(); i++) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    v.setBackgroundResource(C1029R.C1030drawable.material_item_background);
                }
            }
        }
        if ((mode & 1) > 0) {
