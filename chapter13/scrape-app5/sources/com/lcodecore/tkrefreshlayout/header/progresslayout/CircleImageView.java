...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, int color, float radius) {
        ...
        if (elevationSupported()) {
            ...
            ShapeDrawable circle2 = new ShapeDrawable(new OvalShadow(this.mShadowRadius, diameter));
    ...
    private class OvalShadow extends OvalShape {
        ...
        public OvalShadow(int shadowRadius, int circleDiameter) {
            ...
            this.mRadialGradient = new RadialGradient((float) (i / 2), (float) (i / 2), (float) CircleImageView.this.mShadowRadius, new int[]{CircleImageView.FILL_SHADOW_COLOR, 0}, (float[]) null, Shader.TileMode.CLAMP);
