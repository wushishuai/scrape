...
public class ViewPager extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp2 == null || !lp2.isDecor) {
                    ...
                    if (consumeVertical) {
                        ...
                        heightMode3 = MemoryConstants.GB;
                    }
                    measuredWidth = measuredWidth2;
                    if (lp2.width != -2) {
                        widthMode = MemoryConstants.GB;
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(childWidthSize, MemoryConstants.GB);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(childHeightSize, MemoryConstants.GB);
        this.mInLayout = true;
        populate();
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8 && ((lp = (LayoutParams) child2.getLayoutParams()) == null || !lp.isDecor)) {
                child2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp.widthFactor), MemoryConstants.GB), this.mChildHeightMeasureSpec);
            }
        }
    }
                ...
                if (!lp2.isDecor) {
                    ...
                    if (ii != null) {
                        ...
                        if (lp2.needsMeasure) {
                            ...
                            child2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp2.widthFactor), MemoryConstants.GB), View.MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, MemoryConstants.GB));
                        } else {
                            width = width2;
                            paddingLeft = paddingLeft2;
                        }
