...
public class ColorChooserDialog extends DialogFragment implements View.OnClickListener, View.OnLongClickListener {
    ...
    public int getSelectedColor() {
        ...
        return DialogUtils.resolveColor(getActivity(), C0592R.attr.colorAccent, fallback);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Builder builder = getBuilder();
        MaterialDialog.Builder bd = new MaterialDialog.Builder(getActivity()).title(getTitle()).autoDismiss(false).customView(C0592R.layout.md_dialog_colorchooser, false).negativeText(builder.cancelBtn).positiveText(builder.doneBtn).neutralText(builder.allowUserCustom ? builder.customBtn : 0).typeface(builder.mediumFont, builder.regularFont).onPositive(new MaterialDialog.SingleButtonCallback() { // from class: com.afollestad.materialdialogs.color.ColorChooserDialog.4
        ...
        this.grid = (GridView) v.findViewById(C0592R.C0595id.md_grid);
        if (builder.allowUserCustom) {
            this.selectedCustomColor = preselectColor;
            this.colorChooserCustomFrame = v.findViewById(C0592R.C0595id.md_colorChooserCustomFrame);
            this.customColorHex = (EditText) v.findViewById(C0592R.C0595id.md_hexInput);
            this.customColorIndicator = v.findViewById(C0592R.C0595id.md_colorIndicator);
            this.customSeekA = (SeekBar) v.findViewById(C0592R.C0595id.md_colorA);
            this.customSeekAValue = (TextView) v.findViewById(C0592R.C0595id.md_colorAValue);
            this.customSeekR = (SeekBar) v.findViewById(C0592R.C0595id.md_colorR);
            this.customSeekRValue = (TextView) v.findViewById(C0592R.C0595id.md_colorRValue);
            this.customSeekG = (SeekBar) v.findViewById(C0592R.C0595id.md_colorG);
            this.customSeekGValue = (TextView) v.findViewById(C0592R.C0595id.md_colorGValue);
            this.customSeekB = (SeekBar) v.findViewById(C0592R.C0595id.md_colorB);
            this.customSeekBValue = (TextView) v.findViewById(C0592R.C0595id.md_colorBValue);
            if (!builder.allowUserCustomAlpha) {
                v.findViewById(C0592R.C0595id.md_colorALabel).setVisibility(8);
