...
public final class Hpack {
    ...
    static final class Reader {
        ...
        /* JADX INFO: Multiple debug info for r1v8 int: [D('index' int), D('doubled' okhttp3.internal.http2.Header[])] */
        ...
        ByteString readByteString() throws IOException {
            ...
            if (huffmanDecode) {
                return ByteString.m2of(Huffman.get().decode(this.source.readByteArray((long) length)));
            }
