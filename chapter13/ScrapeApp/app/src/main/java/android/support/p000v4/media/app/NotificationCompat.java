...
import android.support.mediacompat.C0206R;
...
public class NotificationCompat {
    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        RemoteViews generateContentView() {
            ...
            view.removeAllViews(C0206R.C0209id.media_actions);
            if (numActionsInCompact > 0) {
                for (int i = 0; i < numActionsInCompact; i++) {
                    if (i < numActions) {
                        view.addView(C0206R.C0209id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                    } else {
            ...
            if (this.mShowCancelButton) {
                view.setViewVisibility(C0206R.C0209id.end_padder, 8);
                view.setViewVisibility(C0206R.C0209id.cancel_action, 0);
                view.setOnClickPendingIntent(C0206R.C0209id.cancel_action, this.mCancelButtonIntent);
                view.setInt(C0206R.C0209id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0206R.integer.cancel_button_image_alpha));
            } else {
                view.setViewVisibility(C0206R.C0209id.end_padder, 0);
                view.setViewVisibility(C0206R.C0209id.cancel_action, 8);
            }
            return view;
        }
        ...
        private RemoteViews generateMediaActionButton(NotificationCompat.Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0206R.layout.notification_media_action);
            button.setImageViewResource(C0206R.C0209id.action0, action.getIcon());
            if (!tombstone) {
                button.setOnClickPendingIntent(C0206R.C0209id.action0, action.getActionIntent());
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0206R.C0209id.action0, action.getTitle());
            }
            return button;
        }

        int getContentViewLayoutResource() {
            return C0206R.layout.notification_template_media;
        }
        ...
        RemoteViews generateBigContentView() {
            ...
            big.removeAllViews(C0206R.C0209id.media_actions);
            if (actionCount > 0) {
                for (int i = 0; i < actionCount; i++) {
                    big.addView(C0206R.C0209id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                big.setViewVisibility(C0206R.C0209id.cancel_action, 0);
                big.setInt(C0206R.C0209id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0206R.integer.cancel_button_image_alpha));
                big.setOnClickPendingIntent(C0206R.C0209id.cancel_action, this.mCancelButtonIntent);
            } else {
                big.setViewVisibility(C0206R.C0209id.cancel_action, 8);
            }
            return big;
        }

        int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0206R.layout.notification_template_big_media_narrow : C0206R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0206R.layout.notification_template_media_custom;
            }
        ...
        @Override // android.support.p000v4.media.app.NotificationCompat.MediaStyle
        int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0206R.layout.notification_template_big_media_narrow_custom : C0206R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews views) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                color = this.mBuilder.mContext.getResources().getColor(C0206R.C0207color.notification_material_background_media_default_color);
            }
            views.setInt(C0206R.C0209id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
}
