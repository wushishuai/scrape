...
public class DividerLine extends RecyclerView.ItemDecoration {
    ...
    private void drawVertical(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            this.dividerDrawable.setBounds(left, top, (getDividerSize() == 0 ? dip2px(this.mContext, 1.0f) : getDividerSize()) + left, bottom);
    ...
    private void drawHorizontal(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            this.dividerDrawable.setBounds(left, top, child.getRight() - params.rightMargin, (getDividerSize() == 0 ? dip2px(this.mContext, 1.0f) : getDividerSize()) + top);
            this.dividerDrawable.draw(c);
        }
    }
