...
public class MDRootLayout extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.buttonBarHeight = r.getDimensionPixelSize(R.dimen.md_button_height);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isVisible(this.titleBar)) {
            this.titleBar.measure(View.MeasureSpec.makeMeasureSpec(width, MemoryConstants.GB), 0);
        ...
        if (isVisible(this.content)) {
            this.content.measure(View.MeasureSpec.makeMeasureSpec(width, MemoryConstants.GB), View.MeasureSpec.makeMeasureSpec(availableHeight - minPadding, Integer.MIN_VALUE));
    ...
    /* JADX INFO: Multiple debug info for r4v5 int: [D('barBottom' int), D('b' int)] */
