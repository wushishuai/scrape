...
public final class FlowableBufferTimed<T, U extends Collection<? super T>> extends AbstractFlowableWithUpstream<T, U> {
    ...
    static final class BufferSkipBoundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable {
        ...
        public void onSubscribe(Subscription s) {
            if (SubscriptionHelper.validate(this.upstream, s)) {
                ...
                try {
                    ...
                    this.downstream.onSubscribe(this);
                    s.request(Long.MAX_VALUE);
                    Scheduler.Worker worker = this.f114w;
                    long j = this.timeskip;
                    worker.schedulePeriodically(this, j, j, this.unit);
                    this.f114w.schedule(new RemoveFromBuffer(collection), this.timespan, this.unit);
                } catch (Throwable e) {
                    Exceptions.throwIfFatal(e);
                    this.f114w.dispose();
                    s.cancel();
        ...
        public void onComplete() {
            ...
            this.done = true;
            if (enter()) {
                QueueDrainHelper.drainMaxLoop(this.queue, this.downstream, false, this.f114w, this);
            }
        }
        ...
        final class RemoveFromBuffer implements Runnable {
            ...
            public void run() {
                ...
                bufferSkipBoundedSubscriber.fastPathOrderedEmitMax(this.buffer, false, bufferSkipBoundedSubscriber.f114w);
            }
        }
    }
        ...
        public void onSubscribe(Subscription s) {
            if (SubscriptionHelper.validate(this.upstream, s)) {
                ...
                try {
                    this.buffer = (U) ((Collection) ObjectHelper.requireNonNull(this.bufferSupplier.call(), "The supplied buffer is null"));
                    this.downstream.onSubscribe(this);
                    Scheduler.Worker worker = this.f113w;
                    long j = this.timespan;
            ...
            synchronized (this) {
                ...
                if (b != null) {
                    ...
                    if (b.size() >= this.maxSize) {
                        ...
                        try {
                            U b2 = (U) ((Collection) ObjectHelper.requireNonNull(this.bufferSupplier.call(), "The supplied buffer is null"));
                            synchronized (this) {
                                this.buffer = b2;
                                this.consumerIndex++;
                            }
