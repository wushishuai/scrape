...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<BitSet> BIT_SET = new TypeAdapter<BitSet>() { // from class: com.google.gson.internal.bind.TypeAdapters.2
        ...
        public BitSet read(JsonReader in) throws IOException {
            ...
            while (tokenType != JsonToken.END_ARRAY) {
                boolean set = false;
                switch (C079236.$SwitchMap$com$google$gson$stream$JsonToken[tokenType.ordinal()]) {
                    case 1:
                        if (in.nextInt() != 0) {
                            set = true;
                            break;
    ...
    public static final TypeAdapter<Number> NUMBER = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
        ...
        public Number read(JsonReader in) throws IOException {
            ...
            int i = C079236.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
            if (i != 1) {
                switch (i) {
                    case 3:
                        break;
    ...
    public static final TypeAdapter<JsonElement> JSON_ELEMENT = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.29
        ...
        public JsonElement read(JsonReader in) throws IOException {
            switch (C079236.$SwitchMap$com$google$gson$stream$JsonToken[in.peek().ordinal()]) {
                case 1:
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C079236 {
        ...
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.35
            ...
            public <T2> TypeAdapter<T2> create(Gson gson, TypeToken<T2> typeToken) {
                ...
                return new TypeAdapter<T1>() { // from class: com.google.gson.internal.bind.TypeAdapters.35.1
                    ...
                    */
                    public T1 read(com.google.gson.stream.JsonReader r5) throws java.io.IOException {
                        /*
                            r4 = this;
                            com.google.gson.internal.bind.TypeAdapters$35 r0 = com.google.gson.internal.bind.TypeAdapters.C079035.this
                            com.google.gson.TypeAdapter r0 = r2
                            java.lang.Object r0 = r0.read(r5)
                            if (r0 == 0) goto L_0x0040
                            java.lang.Class r1 = r0
                        ...
                        L_0x0040:
                            return r0
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C079035.C07911.read(com.google.gson.stream.JsonReader):java.lang.Object");
                    }
                };
            }
