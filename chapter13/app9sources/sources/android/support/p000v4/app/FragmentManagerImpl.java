...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    */
    public void enqueueAction(android.support.p000v4.app.FragmentManagerImpl.OpGenerator r2, boolean r3) {
        /*
            r1 = this;
        ...
        L_0x0005:
            monitor-enter(r1)
            boolean r0 = r1.mDestroyed     // Catch: all -> 0x0030
            if (r0 != 0) goto L_0x0024
            android.support.v4.app.FragmentHostCallback r0 = r1.mHost     // Catch: all -> 0x0030
            if (r0 != 0) goto L_0x000f
            goto L_0x0024
        L_0x000f:
            java.util.ArrayList<android.support.v4.app.FragmentManagerImpl$OpGenerator> r3 = r1.mPendingActions     // Catch: all -> 0x0030
            if (r3 != 0) goto L_0x001a
            java.util.ArrayList r3 = new java.util.ArrayList     // Catch: all -> 0x0030
            r3.<init>()     // Catch: all -> 0x0030
            r1.mPendingActions = r3     // Catch: all -> 0x0030
        L_0x001a:
            java.util.ArrayList<android.support.v4.app.FragmentManagerImpl$OpGenerator> r3 = r1.mPendingActions     // Catch: all -> 0x0030
            r3.add(r2)     // Catch: all -> 0x0030
            r1.scheduleCommit()     // Catch: all -> 0x0030
    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        Fragment fragment;
        if (!ContainerActivity.FRAGMENT.equals(str)) {
            return null;
        }
