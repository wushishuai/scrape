...
public final class MaybeUsing<T, D> extends Maybe<T> {
    ...
    protected void subscribeActual(MaybeObserver<? super T> observer) {
        try {
            ...
            try {
                ((MaybeSource) ObjectHelper.requireNonNull(this.sourceSupplier.apply(call), "The sourceSupplier returned a null MaybeSource")).subscribe(new UsingObserver<>(observer, call, this.resourceDisposer, this.eager));
            } catch (Throwable ex) {
