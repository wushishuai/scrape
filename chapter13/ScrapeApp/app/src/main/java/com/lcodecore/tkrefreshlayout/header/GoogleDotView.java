...
import com.lcodecore.tkrefreshlayout.C0844R;
            ...
            if (this.animating) {
                switch (i) {
                    case 0:
                        ...
                        this.mPath.setColor(getResources().getColor(C0844R.C0845color.Yellow));
                        canvas.drawCircle((float) (((getMeasuredWidth() / 2) - (this.cir_x * 2)) - (((w * 2) / 3) * 2)), (float) (getMeasuredHeight() / 2), this.f76r * this.fraction2, this.mPath);
                        continue;
                    case 1:
                        this.mPath.setAlpha(145);
                        this.mPath.setColor(getResources().getColor(C0844R.C0845color.Green));
                        canvas.drawCircle((float) (((getMeasuredWidth() / 2) - (this.cir_x * 1)) - ((w / 3) * 2)), (float) (getMeasuredHeight() / 2), this.f76r * this.fraction2, this.mPath);
                        continue;
                    case 2:
                        this.mPath.setAlpha(255);
                        this.mPath.setColor(getResources().getColor(C0844R.C0845color.Blue));
                        canvas.drawCircle((float) (getMeasuredWidth() / 2), (float) (getMeasuredHeight() / 2), this.f76r * this.fraction1, this.mPath);
                        continue;
                    case 3:
                        this.mPath.setAlpha(145);
                        this.mPath.setColor(getResources().getColor(C0844R.C0845color.Orange));
                        canvas.drawCircle((float) ((getMeasuredWidth() / 2) + (this.cir_x * 1) + ((w / 3) * 2)), (float) (getMeasuredHeight() / 2), this.f76r * this.fraction2, this.mPath);
                        continue;
                    case 4:
                        this.mPath.setAlpha(105);
                ...
                switch (i) {
                    case 0:
                        this.mPath.setAlpha(105);
                        this.mPath.setColor(getResources().getColor(C0844R.C0845color.Yellow));
                        canvas.drawCircle((float) (((getMeasuredWidth() / 2) - (this.cir_x * 2)) - (((w * 2) / 3) * 2)), (float) (getMeasuredHeight() / 2), this.f76r, this.mPath);
                        continue;
                    case 1:
                        this.mPath.setAlpha(145);
                        this.mPath.setColor(getResources().getColor(C0844R.C0845color.Green));
                        canvas.drawCircle((float) (((getMeasuredWidth() / 2) - (this.cir_x * 1)) - ((w / 3) * 2)), (float) (getMeasuredHeight() / 2), this.f76r, this.mPath);
                        continue;
                    case 2:
                        this.mPath.setAlpha(255);
                        this.mPath.setColor(getResources().getColor(C0844R.C0845color.Blue));
