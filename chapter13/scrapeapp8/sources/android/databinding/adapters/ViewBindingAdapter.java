...
public class ViewBindingAdapter {
    ...
    public static void setOnAttachStateChangeListener(View view, final OnViewDetachedFromWindow detach, final OnViewAttachedToWindow attach) {
        ...
        View.OnAttachStateChangeListener oldListener = (View.OnAttachStateChangeListener) ListenerUtil.trackListener(view, newListener, C0627R.C0630id.onAttachStateChangeListener);
        if (oldListener != null) {
