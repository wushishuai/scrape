    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0452R.C0455id.topPanel) {
                    view = childAt;
                } else if (id == C0452R.C0455id.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0452R.C0455id.contentPanel && id != C0452R.C0455id.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            ...
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(i5, MemoryConstants.f216GB));
