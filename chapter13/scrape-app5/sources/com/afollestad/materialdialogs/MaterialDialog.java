        ...
        if (!isStacked) {
            switch (which) {
                case NEUTRAL:
                    ...
                    Drawable d = DialogUtils.resolveDrawable(this.builder.context, R.attr.md_btn_neutral_selector);
                    if (d != null) {
                        return d;
                    }
                ...
                case NEGATIVE:
                    ...
                    Drawable d3 = DialogUtils.resolveDrawable(this.builder.context, R.attr.md_btn_negative_selector);
                    if (d3 != null) {
                        return d3;
                    }
                ...
                default:
                    ...
                    Drawable d5 = DialogUtils.resolveDrawable(this.builder.context, R.attr.md_btn_positive_selector);
                    if (d5 != null) {
                        return d5;
                    }
            ...
            Drawable d7 = DialogUtils.resolveDrawable(this.builder.context, R.attr.md_btn_stacked_selector);
            if (d7 != null) {
                return d7;
            }
