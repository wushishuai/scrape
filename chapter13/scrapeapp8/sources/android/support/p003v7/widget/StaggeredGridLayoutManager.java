...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    /* JADX INFO: Multiple debug info for r2v2 int: [D('before' int), D('i' int)] */
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (getChildCount() > 0) {
            ...
            state.mSpanOffsetsSize = i2;
            state.mSpanOffsets = new int[i2];
            for (int i3 = 0; i3 < this.mSpanCount; i3++) {
                if (this.mLastLayoutFromEnd) {
                    line = this.mSpans[i3].getEndLine(Integer.MIN_VALUE);
                    if (line != Integer.MIN_VALUE) {
                        line -= this.mPrimaryOrientation.getEndAfterPadding();
                    }
                } else {
                    line = this.mSpans[i3].getStartLine(Integer.MIN_VALUE);
                    if (line != Integer.MIN_VALUE) {
                        line -= this.mPrimaryOrientation.getStartAfterPadding();
                    }
                }
                state.mSpanOffsets[i3] = line;
            }
        } else {
    ...
    */
    private int fill(android.support.p003v7.widget.RecyclerView.Recycler r23, android.support.p003v7.widget.LayoutState r24, android.support.p003v7.widget.RecyclerView.State r25) {
        /*
    ...
    public View onFocusSearchFailed(View focused, int direction, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if ((!this.mReverseLayout) == (layoutDir == -1)) {
