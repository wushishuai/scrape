...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    @Override // android.support.p003v7.widget.MenuItemHoverListener
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        @Override // android.support.p003v7.widget.DropDownListView, android.view.ViewGroup, android.view.View
        public /* bridge */ /* synthetic */ boolean hasFocus() {
            return super.hasFocus();
        }

        @Override // android.support.p003v7.widget.DropDownListView, android.view.View
        ...
        @Override // android.support.p003v7.widget.DropDownListView
        ...
        @Override // android.support.p003v7.widget.DropDownListView, android.widget.AbsListView, android.view.View
        public /* bridge */ /* synthetic */ boolean onTouchEvent(MotionEvent motionEvent) {
            return super.onTouchEvent(motionEvent);
        }

        @Override // android.support.p003v7.widget.DropDownListView, android.widget.AbsListView
