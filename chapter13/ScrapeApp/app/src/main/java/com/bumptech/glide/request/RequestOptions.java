...
public class RequestOptions implements Cloneable {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions sizeMultiplierOf(@FloatRange(from = 0.0d, m55to = 1.0d) float sizeMultiplier) {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions encodeQualityOf(@IntRange(from = 0, m54to = 100) int quality) {
    ...
    @CheckResult
    @NonNull
    public RequestOptions sizeMultiplier(@FloatRange(from = 0.0d, m55to = 1.0d) float sizeMultiplier) {
    ...
    @CheckResult
    @NonNull
    public RequestOptions encodeQuality(@IntRange(from = 0, m54to = 100) int quality) {
