...
public class ControlDistributeLinearLayout extends LinearLayout {
    ...
    public ControlDistributeLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.isDistributeEvent = getContext().obtainStyledAttributes(attrs, R.styleable.ControlDistributeLinearLayout).getBoolean(R.styleable.ControlDistributeLinearLayout_distribute_event, false);
    }
