...
public abstract class BaseFragment<V extends ViewDataBinding, VM extends BaseViewModel> extends RxFragment implements IBaseView {
    ...
    private void initViewDataBinding() {
        ...
        if (this.viewModel == null) {
            ...
            this.viewModel = (VM) ((BaseViewModel) createViewModel(this, modelClass));
        }
    ...
    protected void registorUIChangeLiveDataCallBack() {
        ...
        this.viewModel.getUC().getStartActivityEvent().observe(this, new Observer<Map<String, Object>>() { // from class: me.goldze.mvvmhabit.base.BaseFragment.3
            public void onChanged(@Nullable Map<String, Object> params) {
                BaseFragment.this.startActivity((Class) params.get(BaseViewModel.ParameterField.CLASS), (Bundle) params.get(BaseViewModel.ParameterField.BUNDLE));
            }
        });
        this.viewModel.getUC().getStartContainerActivityEvent().observe(this, new Observer<Map<String, Object>>() { // from class: me.goldze.mvvmhabit.base.BaseFragment.4
            public void onChanged(@Nullable Map<String, Object> params) {
                BaseFragment.this.startContainerActivity((String) params.get(BaseViewModel.ParameterField.CANONICAL_NAME), (Bundle) params.get(BaseViewModel.ParameterField.BUNDLE));
            }
        });
    ...
    public void showDialog(String title) {
        ...
        this.dialog = MaterialDialogUtils.showIndeterminateProgressDialog(getActivity(), title, true).show();
    }
