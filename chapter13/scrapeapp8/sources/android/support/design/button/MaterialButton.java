...
public class MaterialButton extends AppCompatButton {
    ...
    public MaterialButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0091R.attr.materialButtonStyle);
    }

    public MaterialButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0091R.styleable.MaterialButton, defStyleAttr, C0091R.style.Widget_MaterialComponents_Button, new int[0]);
        this.iconPadding = attributes.getDimensionPixelSize(C0091R.styleable.MaterialButton_iconPadding, 0);
        this.iconTintMode = ViewUtils.parseTintMode(attributes.getInt(C0091R.styleable.MaterialButton_iconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.iconTint = MaterialResources.getColorStateList(getContext(), attributes, C0091R.styleable.MaterialButton_iconTint);
        this.icon = MaterialResources.getDrawable(getContext(), attributes, C0091R.styleable.MaterialButton_icon);
        this.iconGravity = attributes.getInteger(C0091R.styleable.MaterialButton_iconGravity, 1);
        this.iconSize = attributes.getDimensionPixelSize(C0091R.styleable.MaterialButton_iconSize, 0);
    ...
    public void setIconPadding(@AbstractC0065Px int iconPadding) {
    ...
    public void setIconSize(@AbstractC0065Px int iconSize) {
        if (iconSize < 0) {
    ...
    public void setStrokeWidth(@AbstractC0065Px int strokeWidth) {
        if (isUsingOriginalBackground()) {
    ...
    public void setCornerRadius(@AbstractC0065Px int cornerRadius) {
        if (isUsingOriginalBackground()) {
