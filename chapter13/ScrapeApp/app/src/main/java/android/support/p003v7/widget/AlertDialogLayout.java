    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0456R.C0459id.topPanel) {
                    topPanel = child;
                } else if (id == C0456R.C0459id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0456R.C0459id.contentPanel && id != C0456R.C0459id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
        ...
        if (buttonPanel != null) {
            ...
            buttonPanel.measure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec(buttonHeight, MemoryConstants.f216GB));
