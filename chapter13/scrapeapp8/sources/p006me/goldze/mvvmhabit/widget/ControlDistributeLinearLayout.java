...
public class ControlDistributeLinearLayout extends LinearLayout {
    ...
    public ControlDistributeLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.isDistributeEvent = getContext().obtainStyledAttributes(attrs, C0933R.styleable.ControlDistributeLinearLayout).getBoolean(C0933R.styleable.ControlDistributeLinearLayout_distribute_event, false);
    }
