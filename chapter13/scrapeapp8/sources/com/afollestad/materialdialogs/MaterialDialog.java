...
public class MaterialDialog extends DialogBase implements View.OnClickListener, DefaultRvAdapter.InternalListCallback {
    ...
    public boolean onItemSelected(MaterialDialog dialog, View view, int position, CharSequence text, boolean longPress) {
        ...
        if (listType == null || listType == ListType.REGULAR) {
            ...
            CheckBox cb = (CheckBox) view.findViewById(C0582R.C0585id.md_control);
            if (!cb.isEnabled()) {
                return false;
            }
            ...
            RadioButton radio = (RadioButton) view.findViewById(C0582R.C0585id.md_control);
            if (!radio.isEnabled()) {
                return false;
            }
    ...
    public final Drawable getListSelector() {
        ...
        Drawable d = DialogUtils.resolveDrawable(this.builder.context, C0582R.attr.md_list_selector);
        if (d != null) {
            return d;
        }
        ...
        if (!isStacked) {
            switch (which) {
                case NEUTRAL:
                    ...
                    Drawable d = DialogUtils.resolveDrawable(this.builder.context, C0582R.attr.md_btn_neutral_selector);
                    if (d != null) {
                        return d;
                    }
                    Drawable d2 = DialogUtils.resolveDrawable(getContext(), C0582R.attr.md_btn_neutral_selector);
                ...
                case NEGATIVE:
                    ...
                    Drawable d3 = DialogUtils.resolveDrawable(this.builder.context, C0582R.attr.md_btn_negative_selector);
                    if (d3 != null) {
                        return d3;
                    }
                    Drawable d4 = DialogUtils.resolveDrawable(getContext(), C0582R.attr.md_btn_negative_selector);
                    if (Build.VERSION.SDK_INT >= 21) {
                ...
                default:
                    ...
                    Drawable d5 = DialogUtils.resolveDrawable(this.builder.context, C0582R.attr.md_btn_positive_selector);
                    if (d5 != null) {
                        return d5;
                    }
                    Drawable d6 = DialogUtils.resolveDrawable(getContext(), C0582R.attr.md_btn_positive_selector);
                    if (Build.VERSION.SDK_INT >= 21) {
            ...
            Drawable d7 = DialogUtils.resolveDrawable(this.builder.context, C0582R.attr.md_btn_stacked_selector);
            if (d7 != null) {
                return d7;
            }
