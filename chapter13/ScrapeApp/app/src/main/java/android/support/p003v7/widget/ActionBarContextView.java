...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C0456R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0456R.styleable.ActionMode, defStyle, 0);
        ViewCompat.setBackground(this, a.getDrawable(C0456R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C0456R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C0456R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a.getLayoutDimension(C0456R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = a.getResourceId(C0456R.styleable.ActionMode_closeItemLayout, C0456R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0456R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0456R.C0459id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0456R.C0459id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        this.mClose.findViewById(C0456R.C0459id.action_mode_close_button).setOnClickListener(new View.OnClickListener() { // from class: android.support.v7.widget.ActionBarContextView.1
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int customHeightMode = MemoryConstants.f216GB;
        if (widthMode != 1073741824) {
            ...
            if (view2 != null) {
                ...
                int customWidthMode = lp2.width != -2 ? MemoryConstants.f216GB : Integer.MIN_VALUE;
