    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            if (!(childAt.getVisibility() == 8 || (layoutParams2 = (LayoutParams) childAt.getLayoutParams()) == null || !layoutParams2.isDecor)) {
                ...
                if (z2) {
                    i12 = MemoryConstants.f216GB;
                    i3 = Integer.MIN_VALUE;
                } else {
                    i3 = z ? MemoryConstants.f216GB : Integer.MIN_VALUE;
                }
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(i7, MemoryConstants.f216GB);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(i6, MemoryConstants.f216GB);
        this.mInLayout = true;
        populate();
        ...
        for (int i13 = 0; i13 < childCount2; i13++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) i7) * layoutParams.widthFactor), MemoryConstants.f216GB), this.mChildHeightMeasureSpec);
            }
        }
    }
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (infoForChild = infoForChild(childAt2)) != null) {
                    ...
                    if (layoutParams2.needsMeasure) {
                        ...
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.widthFactor), MemoryConstants.f216GB), View.MeasureSpec.makeMeasureSpec((i8 - i11) - i9, MemoryConstants.f216GB));
                    }
