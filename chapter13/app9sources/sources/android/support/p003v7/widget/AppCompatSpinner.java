...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, null, C0452R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0452R.attr.spinnerStyle);
    }
    ...
    */
    public AppCompatSpinner(android.content.Context r8, android.util.AttributeSet r9, int r10, int r11, android.content.res.Resources.Theme r12) {
        /*
            ...
            r0.<init>()
            r7.mTempRect = r0
            int[] r0 = android.support.p003v7.appcompat.C0452R.styleable.Spinner
            r1 = 0
            android.support.v7.widget.TintTypedArray r0 = android.support.p003v7.widget.TintTypedArray.obtainStyledAttributes(r8, r9, r0, r10, r1)
            ...
            goto L_0x003e
        L_0x0023:
            int r12 = android.support.p003v7.appcompat.C0452R.styleable.Spinner_popupTheme
        ...
        L_0x003e:
            ...
            int[] r12 = android.support.p003v7.widget.AppCompatSpinner.ATTRS_ANDROID_SPINNERMODE     // Catch: Exception -> 0x0061, all -> 0x005e
            android.content.res.TypedArray r12 = r8.obtainStyledAttributes(r9, r12, r10, r1)     // Catch: Exception -> 0x0061, all -> 0x005e
            boolean r4 = r12.hasValue(r1)     // Catch: Exception -> 0x005c, all -> 0x006d
            if (r4 == 0) goto L_0x0056
            int r11 = r12.getInt(r1, r1)     // Catch: Exception -> 0x005c, all -> 0x006d
        L_0x0056:
        ...
        L_0x0074:
            ...
            r11.<init>(r12, r9, r10)
            android.content.Context r12 = r7.mPopupContext
            int[] r4 = android.support.p003v7.appcompat.C0452R.styleable.Spinner
            android.support.v7.widget.TintTypedArray r12 = android.support.p003v7.widget.TintTypedArray.obtainStyledAttributes(r12, r9, r4, r10, r1)
            int r1 = android.support.p003v7.appcompat.C0452R.styleable.Spinner_android_dropDownWidth
            r4 = -2
            int r1 = r12.getLayoutDimension(r1, r4)
            r7.mDropDownWidth = r1
            int r1 = android.support.p003v7.appcompat.C0452R.styleable.Spinner_android_popupBackground
            android.graphics.drawable.Drawable r1 = r12.getDrawable(r1)
            r11.setBackgroundDrawable(r1)
            int r1 = android.support.p003v7.appcompat.C0452R.styleable.Spinner_android_prompt
        ...
        L_0x00ac:
            int r11 = android.support.p003v7.appcompat.C0452R.styleable.Spinner_android_entries
            ...
            r12.<init>(r8, r1, r11)
            int r8 = android.support.p003v7.appcompat.C0452R.layout.support_simple_spinner_dropdown_item
    ...
    public class DropdownPopup extends ListPopupWindow {
        ...
        public DropdownPopup(Context context, AttributeSet attributeSet, int i) {
            ...
            setModal(true);
            setPromptPosition(0);
            setOnItemClickListener(new AdapterView.OnItemClickListener(AppCompatSpinner.this) { // from class: android.support.v7.widget.AppCompatSpinner.DropdownPopup.1
        ...
        @Override // android.support.p003v7.widget.ListPopupWindow
        ...
        @Override // android.support.p003v7.widget.ListPopupWindow, android.support.p003v7.view.menu.ShowableListMenu
        public void show() {
            ...
            if (!isShowing && (viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver()) != null) {
                final ViewTreeObserver$OnGlobalLayoutListenerC05012 r1 = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: android.support.v7.widget.AppCompatSpinner.DropdownPopup.2
                ...
                setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: android.support.v7.widget.AppCompatSpinner.DropdownPopup.3
                    ...
                    public void onDismiss() {
                        ...
                        if (viewTreeObserver2 != null) {
                            viewTreeObserver2.removeGlobalOnLayoutListener(r1);
                        }
                    }
                });
            }
