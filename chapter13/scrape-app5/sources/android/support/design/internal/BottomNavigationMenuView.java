...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightSpec = View.MeasureSpec.makeMeasureSpec(this.itemHeight, MemoryConstants.GB);
        int i = 8;
        ...
        for (int i4 = 0; i4 < totalCount; i4++) {
            ...
            if (child.getVisibility() != 8) {
                child.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths[i4], MemoryConstants.GB), heightSpec);
                child.getLayoutParams().width = child.getMeasuredWidth();
                totalWidth += child.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(totalWidth, View.MeasureSpec.makeMeasureSpec(totalWidth, MemoryConstants.GB), 0), View.resolveSizeAndState(this.itemHeight, heightSpec, 0));
    }
