...
public class DownLoadManager {
    ...
    public void load(String downUrl, final ProgressCallBack callBack) {
        ((ApiService) retrofit.create(ApiService.class)).download(downUrl).subscribeOn(Schedulers.m27io()).observeOn(Schedulers.m27io()).doOnNext(new Consumer<ResponseBody>() { // from class: me.goldze.mvvmhabit.http.DownLoadManager.1
