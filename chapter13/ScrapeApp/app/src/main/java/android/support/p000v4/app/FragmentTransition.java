...
public class FragmentTransition {
    ...
    private static void replaceHide(FragmentTransitionImpl impl, Object exitTransition, Fragment exitingFragment, final ArrayList<View> exitingViews) {
        if (exitingFragment != null && exitTransition != null && exitingFragment.mAdded && exitingFragment.mHidden && exitingFragment.mHiddenChanged) {
            ...
            OneShotPreDrawListener.add(exitingFragment.mContainer, new Runnable() { // from class: android.support.v4.app.FragmentTransition.1
    ...
    */
    private static void addToFirstInLastOut(android.support.p000v4.app.BackStackRecord r22, android.support.p000v4.app.BackStackRecord.C0273Op r23, android.util.SparseArray<android.support.p000v4.app.FragmentTransition.FragmentContainerTransition> r24, boolean r25, boolean r26) {
        /*
