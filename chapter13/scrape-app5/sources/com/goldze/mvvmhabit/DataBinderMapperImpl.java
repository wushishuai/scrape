...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    static {
        ...
        INTERNAL_LAYOUT_ID_LOOKUP.put(R.layout.fragment_index, 3);
        INTERNAL_LAYOUT_ID_LOOKUP.put(R.layout.item, 4);
    }
    ...
    private static class InnerLayoutIdLookup {
        ...
        static {
            ...
            sKeys.put("layout/fragment_detail_0", Integer.valueOf((int) R.layout.fragment_detail));
            sKeys.put("layout/fragment_index_0", Integer.valueOf((int) R.layout.fragment_index));
            sKeys.put("layout/item_0", Integer.valueOf((int) R.layout.item));
        }
    }
}
