...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new ViewPropertyAnimatorUpdateListener() { // from class: android.support.v7.app.WindowDecorActionBar.3
        @Override // android.support.p000v4.view.ViewPropertyAnimatorUpdateListener
    ...
    @Override // android.support.p003v7.widget.ActionBarOverlayLayout.ActionBarVisibilityCallback
    public void onContentScrollStopped() {
    }

    @Override // android.support.p003v7.app.ActionBar
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0452R.C0455id.decor_content_parent);
        ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0452R.C0455id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0452R.C0455id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0452R.C0455id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0452R.styleable.ActionBar, C0452R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0452R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0452R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0452R.attr.actionBarWidgetTheme, typedValue, true);
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        @Override // android.support.p003v7.view.ActionMode
    ...
    public class TabImpl extends ActionBar.Tab {
        ...
        @Override // android.support.p003v7.app.ActionBar.Tab
