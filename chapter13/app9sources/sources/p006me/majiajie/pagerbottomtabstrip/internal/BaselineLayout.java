...
/* renamed from: me.majiajie.pagerbottomtabstrip.internal.BaselineLayout */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                i7 |= ViewCompat.getMeasuredState(childAt);
            }
        }
        if (i3 != -1) {
        ...
        setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(i6, getSuggestedMinimumWidth()), i, i7), ViewCompat.resolveSizeAndState(Math.max(i5, getSuggestedMinimumHeight()), i2, i7 << 16));
    }
