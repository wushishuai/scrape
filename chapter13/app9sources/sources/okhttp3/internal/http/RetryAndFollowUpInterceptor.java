...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    private Address createAddress(HttpUrl httpUrl) {
        ...
        if (httpUrl.isHttps()) {
            ...
            HostnameVerifier hostnameVerifier2 = this.client.hostnameVerifier();
    ...
    private int retryAfter(Response response, int i) {
        ...
        return header.matches("\\d+") ? Integer.valueOf(header).intValue() : ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
    }
