...
public class MaterialDialog extends DialogBase implements View.OnClickListener, DefaultRvAdapter.InternalListCallback {
                    ...
                    if (MaterialDialog.this.listType == ListType.SINGLE || MaterialDialog.this.listType == ListType.MULTI) {
                        ...
                        MaterialDialog.this.recyclerView.post(new Runnable() { // from class: com.afollestad.materialdialogs.MaterialDialog.1.1
                            ...
                            public void run() {
                                ...
                                MaterialDialog.this.builder.layoutManager.scrollToPosition(selectedIndex);
                            }
                        });
                    }
                }
    ...
    public boolean onItemSelected(MaterialDialog dialog, View view, int position, CharSequence text, boolean longPress) {
        ...
        if (listType == null || listType == ListType.REGULAR) {
            ...
            CheckBox cb = (CheckBox) view.findViewById(C0583R.C0586id.md_control);
            if (!cb.isEnabled()) {
                return false;
            }
            ...
            RadioButton radio = (RadioButton) view.findViewById(C0583R.C0586id.md_control);
            if (!radio.isEnabled()) {
                return false;
            }
    ...
    public final Drawable getListSelector() {
        ...
        Drawable d = DialogUtils.resolveDrawable(this.builder.context, C0583R.attr.md_list_selector);
        if (d != null) {
            return d;
        }
        return DialogUtils.resolveDrawable(getContext(), C0583R.attr.md_list_selector);
    }
        ...
        if (!isStacked) {
            switch (which) {
                case NEUTRAL:
                    ...
                    Drawable d = DialogUtils.resolveDrawable(this.builder.context, C0583R.attr.md_btn_neutral_selector);
                    if (d != null) {
                        return d;
                    }
                    Drawable d2 = DialogUtils.resolveDrawable(getContext(), C0583R.attr.md_btn_neutral_selector);
                    if (Build.VERSION.SDK_INT >= 21) {
                        RippleHelper.applyColor(d2, this.builder.buttonRippleColor);
                    }
                    return d2;
                case NEGATIVE:
                    ...
                    Drawable d3 = DialogUtils.resolveDrawable(this.builder.context, C0583R.attr.md_btn_negative_selector);
                    if (d3 != null) {
                        return d3;
                    }
                    Drawable d4 = DialogUtils.resolveDrawable(getContext(), C0583R.attr.md_btn_negative_selector);
                    if (Build.VERSION.SDK_INT >= 21) {
                        RippleHelper.applyColor(d4, this.builder.buttonRippleColor);
                    }
                    return d4;
                default:
                    ...
                    Drawable d5 = DialogUtils.resolveDrawable(this.builder.context, C0583R.attr.md_btn_positive_selector);
                    if (d5 != null) {
                        return d5;
                    }
                    Drawable d6 = DialogUtils.resolveDrawable(getContext(), C0583R.attr.md_btn_positive_selector);
                    if (Build.VERSION.SDK_INT >= 21) {
                        RippleHelper.applyColor(d6, this.builder.buttonRippleColor);
                    }
                    return d6;
            }
            ...
            Drawable d7 = DialogUtils.resolveDrawable(this.builder.context, C0583R.attr.md_btn_stacked_selector);
            if (d7 != null) {
                return d7;
            }
            return DialogUtils.resolveDrawable(getContext(), C0583R.attr.md_btn_stacked_selector);
        }
    }
    ...
    public void setIconAttribute(@AttrRes int attrId) {
        setIcon(DialogUtils.resolveDrawable(this.builder.context, attrId));
    }
    ...
    @UiThread
    public final void notifyItemInserted(@IntRange(from = 0, m54to = 2147483647L) int index) {
        this.builder.adapter.notifyItemInserted(index);
    }

    @UiThread
    public final void notifyItemChanged(@IntRange(from = 0, m54to = 2147483647L) int index) {
    ...
    public enum ListType {
        ...
        public static int getLayoutForType(ListType type) {
            switch (type) {
                case REGULAR:
                    return C0583R.layout.md_listitem;
                case SINGLE:
                    return C0583R.layout.md_listitem_singlechoice;
                case MULTI:
                    return C0583R.layout.md_listitem_multichoice;
                default:
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context) {
            ...
            this.widgetColor = DialogUtils.resolveColor(context, C0583R.attr.colorAccent, DialogUtils.getColor(context, C0583R.C0584color.md_material_blue_600));
            if (Build.VERSION.SDK_INT >= 21) {
            ...
            this.linkColor = DialogUtils.getActionTextStateList(context, DialogUtils.resolveColor(context, C0583R.attr.md_link_color, this.widgetColor));
            this.buttonRippleColor = DialogUtils.resolveColor(context, C0583R.attr.md_btn_ripple_color, DialogUtils.resolveColor(context, C0583R.attr.colorControlHighlight, Build.VERSION.SDK_INT >= 21 ? DialogUtils.resolveColor(context, 16843820) : 0));
            this.progressPercentFormat = NumberFormat.getPercentInstance();
            this.progressNumberFormat = "%1d/%2d";
            this.theme = DialogUtils.isColorDark(DialogUtils.resolveColor(context, 16842806)) ? Theme.LIGHT : Theme.DARK;
            checkSingleton();
            this.titleGravity = DialogUtils.resolveGravityEnum(context, C0583R.attr.md_title_gravity, this.titleGravity);
            this.contentGravity = DialogUtils.resolveGravityEnum(context, C0583R.attr.md_content_gravity, this.contentGravity);
            this.btnStackedGravity = DialogUtils.resolveGravityEnum(context, C0583R.attr.md_btnstacked_gravity, this.btnStackedGravity);
            this.itemsGravity = DialogUtils.resolveGravityEnum(context, C0583R.attr.md_items_gravity, this.itemsGravity);
            this.buttonsGravity = DialogUtils.resolveGravityEnum(context, C0583R.attr.md_buttons_gravity, this.buttonsGravity);
            try {
                typeface(DialogUtils.resolveString(context, C0583R.attr.md_medium_font), DialogUtils.resolveString(context, C0583R.attr.md_regular_font));
            } catch (Throwable th) {
            }
        ...
        public Builder content(@StringRes int contentRes, Object... formatArgs) {
            return content(Html.fromHtml(String.format(this.context.getString(contentRes), formatArgs).replace("\n", "<br/>")));
        }
        ...
        public Builder input(@StringRes int hint, @StringRes int prefill, boolean allowEmptyInput, @NonNull InputCallback callback) {
            ...
            if (hint == 0) {
                ...
                charSequence = this.context.getText(hint);
            }
            if (prefill != 0) {
                charSequence2 = this.context.getText(prefill);
            }
            return input(charSequence, charSequence2, allowEmptyInput, callback);
        }
        ...
        public Builder inputRange(@IntRange(from = 0, m54to = 2147483647L) int minLength, @IntRange(from = -1, m54to = 2147483647L) int maxLength) {
            return inputRange(minLength, maxLength, 0);
        }

        public Builder inputRange(@IntRange(from = 0, m54to = 2147483647L) int minLength, @IntRange(from = -1, m54to = 2147483647L) int maxLength, @ColorInt int errorColor) {
            if (minLength >= 0) {
                this.inputMinLength = minLength;
                this.inputMaxLength = maxLength;
                if (errorColor == 0) {
                    this.inputRangeErrorColor = DialogUtils.getColor(this.context, C0583R.C0584color.md_edittext_error);
                } else {
        ...
        public Builder inputRangeRes(@IntRange(from = 0, m54to = 2147483647L) int minLength, @IntRange(from = -1, m54to = 2147483647L) int maxLength, @ColorRes int errorColor) {
