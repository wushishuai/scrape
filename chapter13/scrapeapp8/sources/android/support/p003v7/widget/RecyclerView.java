...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a2 = context.obtainStyledAttributes(attrs, C0460R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a2.getString(C0460R.styleable.RecyclerView_layoutManager);
            if (a2.getInt(C0460R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a2.getBoolean(C0460R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a2.getDrawable(C0460R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a2.getDrawable(C0460R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a2.getDrawable(C0460R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a2.getDrawable(C0460R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a2.recycle();
    ...
    */
    ...
    public void smoothScrollBy(@AbstractC0065Px int dx, @AbstractC0065Px int dy) {
        smoothScrollBy(dx, dy, null);
    }

    public void smoothScrollBy(@AbstractC0065Px int dx, @AbstractC0065Px int dy, @Nullable Interpolator interpolator) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutFrozen) {
    ...
    */
    ...
    public void offsetChildrenVertical(@AbstractC0065Px int dy) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i = 0; i < childCount; i++) {
    ...
    public void offsetChildrenHorizontal(@AbstractC0065Px int dx) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i = 0; i < childCount; i++) {
    ...
    public void onScrolled(@AbstractC0065Px int dx, @AbstractC0065Px int dy) {
    }
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0460R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0460R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0460R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0460R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0460R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0460R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0460R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0460R.dimen.fastscroll_margin));
    }
    ...
    public static abstract class SmoothScroller {
        ...
        protected abstract void onSeekTargetStep(@AbstractC0065Px int i, @AbstractC0065Px int i2, @NonNull State state, @NonNull Action action);
        ...
        public static class Action {
            ...
            public Action(@AbstractC0065Px int dx, @AbstractC0065Px int dy) {
                this(dx, dy, Integer.MIN_VALUE, null);
            }

            public Action(@AbstractC0065Px int dx, @AbstractC0065Px int dy, int duration) {
                this(dx, dy, duration, null);
            }

            public Action(@AbstractC0065Px int dx, @AbstractC0065Px int dy, int duration, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@AbstractC0065Px int dx) {
                this.mChanged = true;
                this.mDx = dx;
            }
            ...
            public void setDy(@AbstractC0065Px int dy) {
                this.mChanged = true;
                this.mDy = dy;
            }
            ...
            public void update(@AbstractC0065Px int dx, @AbstractC0065Px int dy, int duration, @Nullable Interpolator interpolator) {
                this.mDx = dx;
                this.mDy = dy;
                this.mDuration = duration;
                this.mInterpolator = interpolator;
