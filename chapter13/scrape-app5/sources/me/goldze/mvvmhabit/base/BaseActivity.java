...
public abstract class BaseActivity<V extends ViewDataBinding, VM extends BaseViewModel> extends RxAppCompatActivity implements IBaseView {
    ...
    protected void registorUIChangeLiveDataCallBack() {
        ...
        this.viewModel.getUC().getStartActivityEvent().observe(this, new Observer<Map<String, Object>>() { // from class: me.goldze.mvvmhabit.base.BaseActivity.3
            public void onChanged(@Nullable Map<String, Object> params) {
                BaseActivity.this.startActivity((Class) params.get(BaseViewModel.ParameterField.CLASS), (Bundle) params.get(BaseViewModel.ParameterField.BUNDLE));
            }
        });
        this.viewModel.getUC().getStartContainerActivityEvent().observe(this, new Observer<Map<String, Object>>() { // from class: me.goldze.mvvmhabit.base.BaseActivity.4
            public void onChanged(@Nullable Map<String, Object> params) {
                BaseActivity.this.startContainerActivity((String) params.get(BaseViewModel.ParameterField.CANONICAL_NAME), (Bundle) params.get(BaseViewModel.ParameterField.BUNDLE));
            }
        });
    ...
    public void showDialog(String title) {
        ...
        this.dialog = MaterialDialogUtils.showIndeterminateProgressDialog(this, title, true).show();
    }
