...
public class SinaRefreshView extends FrameLayout implements IHeaderView {
    ...
    private void init() {
        View rootView = View.inflate(getContext(), C0844R.layout.view_sinaheader, null);
        this.refreshArrow = (ImageView) rootView.findViewById(C0844R.C0847id.iv_arrow);
        this.refreshTextView = (TextView) rootView.findViewById(C0844R.C0847id.f72tv);
        this.loadingView = (ImageView) rootView.findViewById(C0844R.C0847id.iv_loading);
        addView(rootView);
    }
