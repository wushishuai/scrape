...
import okhttp3.internal.p008ws.WebSocketReader;
...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random, long j) {
        if ("GET".equals(request.method())) {
            ...
            this.key = ByteString.m2of(bArr).base64();
    ...
    @Override // okhttp3.internal.p008ws.WebSocketReader.FrameCallback
        ...
        synchronized (this) {
            ...
            try {
                if (poll != null) {
                    ...
                    BufferedSink buffer = Okio.buffer(webSocketWriter.newMessageSink(((Message) obj).formatOpcode, (long) byteString.size()));
