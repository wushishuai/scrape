...
class ViewGroupUtilsApi14 {
    ...
    public static void suppressLayout(@NonNull ViewGroup group, boolean suppress) {
        ...
        if (suppress) {
            ...
            if (layoutTransition != null) {
                ...
                if (layoutTransition != sEmptyLayoutTransition) {
                    group.setTag(C0244R.C0247id.transition_layout_save, layoutTransition);
                }
            }
        ...
        LayoutTransition layoutTransition2 = (LayoutTransition) group.getTag(C0244R.C0247id.transition_layout_save);
        if (layoutTransition2 != null) {
            group.setTag(C0244R.C0247id.transition_layout_save, null);
