...
public class ActivityCompat extends ContextCompat {
    ...
    public interface OnRequestPermissionsResultCallback {
        @Override // android.support.p000v4.app.ActivityCompat.OnRequestPermissionsResultCallback
    ...
    public static class SharedElementCallback21Impl extends SharedElementCallback {
        ...
        public void onSharedElementsArrived(List<String> sharedElementNames, List<View> sharedElements, final SharedElementCallback.OnSharedElementsReadyListener listener) {
            this.mCallback.onSharedElementsArrived(sharedElementNames, sharedElements, new SharedElementCallback.OnSharedElementsReadyListener() { // from class: android.support.v4.app.ActivityCompat.SharedElementCallback21Impl.1
                @Override // android.support.p000v4.app.SharedElementCallback.OnSharedElementsReadyListener
