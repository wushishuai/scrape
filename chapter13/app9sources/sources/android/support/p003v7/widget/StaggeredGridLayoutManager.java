...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    */
    private void onLayoutChildren(android.support.p003v7.widget.RecyclerView.Recycler r9, android.support.p003v7.widget.RecyclerView.State r10, boolean r11) {
        /*
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
            ...
            if (layoutState.hasMore(state)) {
                ...
                if (z4) {
                    if (layoutParams.mFullSpan) {
                        ...
                        span2 = getNextSpan(layoutState);
                    }
                    this.mLazySpanLookup.setSpan(viewLayoutPosition, span2);
                    span = span2;
                } else {
        ...
        return i4 > 0 ? Math.min(layoutState.mAvailable, i4) : i3;
    }
