...
public final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = (float) this.context.getResources().getDimensionPixelSize(C0091R.dimen.design_textinput_caption_translate_y);
    }
    ...
    public void setErrorEnabled(boolean z) {
        if (this.errorEnabled != z) {
            ...
            if (z) {
                ...
                this.errorView.setId(C0091R.C0094id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean z) {
        if (this.helperTextEnabled != z) {
            ...
            if (z) {
                ...
                this.helperTextView.setId(C0091R.C0094id.textinput_helper_text);
                Typeface typeface = this.typeface;
                if (typeface != null) {
