...
class GhostViewApi14 extends View implements GhostViewImpl {
    ...
    protected void onAttachedToWindow() {
        ...
        int[] viewLocation = {(int) (((float) viewLocation[0]) - this.mView.getTranslationX()), (int) (((float) viewLocation[1]) - this.mView.getTranslationY())};
    ...
    private static void setGhostView(@NonNull View view, GhostViewApi14 ghostView) {
        view.setTag(C0244R.C0247id.ghost_view, ghostView);
    }

    static GhostViewApi14 getGhostView(@NonNull View view) {
        return (GhostViewApi14) view.getTag(C0244R.C0247id.ghost_view);
    }
}
