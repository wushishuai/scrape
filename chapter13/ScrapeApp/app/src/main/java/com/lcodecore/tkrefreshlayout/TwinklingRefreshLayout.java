...
public class TwinklingRefreshLayout extends RelativeLayout implements PullListener, NestedScrollingChild {
    ...
    public TwinklingRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0844R.styleable.TwinklingRefreshLayout, defStyleAttr, 0);
        try {
            this.mMaxHeadHeight = (float) a.getDimensionPixelSize(C0844R.styleable.TwinklingRefreshLayout_tr_max_head_height, DensityUtil.dp2px(context, 120.0f));
            this.mHeadHeight = (float) a.getDimensionPixelSize(C0844R.styleable.TwinklingRefreshLayout_tr_head_height, DensityUtil.dp2px(context, 80.0f));
            this.mMaxBottomHeight = (float) a.getDimensionPixelSize(C0844R.styleable.TwinklingRefreshLayout_tr_max_bottom_height, DensityUtil.dp2px(context, 120.0f));
            this.mBottomHeight = (float) a.getDimensionPixelSize(C0844R.styleable.TwinklingRefreshLayout_tr_bottom_height, DensityUtil.dp2px(context, 60.0f));
            this.mOverScrollHeight = (float) a.getDimensionPixelSize(C0844R.styleable.TwinklingRefreshLayout_tr_overscroll_height, (int) this.mHeadHeight);
            this.enableRefresh = a.getBoolean(C0844R.styleable.TwinklingRefreshLayout_tr_enable_refresh, true);
            this.enableLoadmore = a.getBoolean(C0844R.styleable.TwinklingRefreshLayout_tr_enable_loadmore, true);
            this.isPureScrollModeOn = a.getBoolean(C0844R.styleable.TwinklingRefreshLayout_tr_pureScrollMode_on, false);
            this.isOverScrollTopShow = a.getBoolean(C0844R.styleable.TwinklingRefreshLayout_tr_overscroll_top_show, true);
            this.isOverScrollBottomShow = a.getBoolean(C0844R.styleable.TwinklingRefreshLayout_tr_overscroll_bottom_show, true);
            this.enableOverScroll = a.getBoolean(C0844R.styleable.TwinklingRefreshLayout_tr_enable_overscroll, true);
            this.floatRefresh = a.getBoolean(C0844R.styleable.TwinklingRefreshLayout_tr_floatRefresh, false);
            this.autoLoadMore = a.getBoolean(C0844R.styleable.TwinklingRefreshLayout_tr_autoLoadMore, false);
            this.enableKeepIView = a.getBoolean(C0844R.styleable.TwinklingRefreshLayout_tr_enable_keepIView, true);
            this.showRefreshingWhenOverScroll = a.getBoolean(C0844R.styleable.TwinklingRefreshLayout_tr_showRefreshingWhenOverScroll, true);
            this.showLoadingWhenOverScroll = a.getBoolean(C0844R.styleable.TwinklingRefreshLayout_tr_showLoadingWhenOverScroll, true);
            a.recycle();
    ...
    private void addHeader() {
        ...
        extraHeadLayout.setId(C0844R.C0847id.ex_header);
